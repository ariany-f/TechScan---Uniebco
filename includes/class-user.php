...
class User
{
  ...
  public function update_policy()
  {
    ...
    /* check user */
    if ($this->_data['user_policy_verified'] == 1) {
      /* user email already verified => redirect */
      redirect();
    }

    /* [1] activate his account & verify his email */
    $db->query(sprintf("UPDATE users SET user_policy_verified = '1' WHERE user_id = %s", secure($this->_data['user_id'], 'int'))) or _error("SQL_ERROR_THROWEN");
    /* affiliates system */
  ...
  public function get_new_people($offset = 0, $random = false)
  {
    ...
    if ($system['activation_enabled'] && (!$this->_is_admin)) {
    ...
    switch ($do) {
      ...
      case 'group-invite':
        ...
        if(!$this->_is_admin) {
          ...
          $check_viewer = $db->query(sprintf("SELECT `groups`.* FROM `groups` INNER JOIN groups_members ON `groups`.group_id = groups_members.group_id WHERE groups_members.group_id = %s", secure($id, 'int'))) or _error("SQL_ERROR_THROWEN");
        }
        /* if no -> return */
        if ($check_viewer->num_rows == 0) return;
        ...
        if ($group['group_privacy'] == 'public') {
          /* the group is public */
          $approved = '1';
        } elseif ($this->_data['user_id'] == $group['group_admin'] || $this->_is_admin) {
      ...
      while ($notification = $get_notifications->fetch_assoc()) {
        ...
        switch ($notification['action']) {
          ...
          case 'friend_add':
            ...
            $notification['url'] = $system['system_url'] . '/comunidade/' . $notification['user_name'];
          ...
          case 'gift':
            ...
            $notification['url'] = $system['system_url'] . '/comunidade/' . $this->_data['user_name'] . '?gift=' . $notification['node_url'];
          ...
          case 'react_angry':
            ...
            if ($notification['node_type'] == "post") {
              $notification['url'] = $system['system_url'] . '/comunidade/posts/' . $notification['node_url'];
              $notification['message'] = __("reacted to your post");
            } elseif ($notification['node_type'] == "photo") {
              $notification['url'] = $system['system_url'] . '/comunidade/photos/' . $notification['node_url'];
              $notification['message'] = __("reacted to your photo");
            } elseif ($notification['node_type'] == "post_comment") {
              $notification['url'] = $system['system_url'] . '/comunidade/posts/' . $notification['node_url'] . $notification['notify_id'];
              $notification['message'] = __("reacted to your comment");
            } elseif ($notification['node_type'] == "photo_comment") {
              $notification['url'] = $system['system_url'] . '/comunidade/photos/' . $notification['node_url'] . $notification['notify_id'];
              $notification['message'] = __("reacted to your comment");
          ...
          case 'page_invitation':
            ...
            $notification['url'] = $system['system_url'] . '/comunidade/pages/' . $notification['node_url'];
          ...
          case 'group_join':
            $notification['icon'] = "fa fa-users";
            $notification['url'] = $system['system_url'] . '/comunidade/groups/' . $notification['node_url'] . '/settings/requests';
            $notification['message'] = __("asked to join your group") . " '" . html_entity_decode($notification['node_type'], ENT_QUOTES) . "'";
            break;

          case 'group_add':
            $notification['icon'] = "fa fa-users";
            $notification['url'] = $system['system_url'] . '/comunidade/groups/' . $notification['node_url'];
          ...
          case 'group_post_pending':
            $notification['icon'] = "fa fa-users";
            $notification['url'] = $system['system_url'] . '/comunidade/groups/' . $notification['node_url'] . '?pending';
          ...
          case 'event_invitation':
            ...
            $notification['url'] = $system['system_url'] . '/comunidade/events/' . $notification['node_url'];
          ...
          case 'event_post_pending':
            $notification['icon'] = "fa fa-calendar";
            $notification['url'] = $system['system_url'] . '/comunidade/events/' . $notification['node_url'] . '?pending';
          ...
          case 'forum_reply':
            $notification['icon'] = "fa fa-comment";
            $notification['url'] = $system['system_url'] . '/comunidade/forums/thread/' . $notification['node_url'];
            $notification['message'] = __("replied to your thread");
            break;

          case 'money_sent':
            $notification['icon'] = "fa fa-gift";
            $notification['url'] = $system['system_url'] . '/comunidade/wallet';
          ...
          case 'coinpayments_complete':
            ...
            $notification['url'] = $system['system_url'] . '/comunidade/settings/coinpayments';
            $notification['message'] = __("Your CoinPayments transaction complete successfully");
            break;

          case 'bank_transfer':
            $notification['icon'] = "fa fa-university";
            $notification['url'] = $system['system_url'] . '/comunidade/' . $control_panel['url'] . '/bank';
            $notification['message'] = __("Sent new bank transfer");
            break;

          case 'bank_transfer_approved':
            $notification['icon'] = "fa fa-university";
            $notification['url'] = $system['system_url'] . '/comunidade/settings/bank';
          ...
          case 'wallet_withdrawal':
            ...
            $notification['url'] = $system['system_url'] . '/comunidade/' . $control_panel['url'] . '/wallet/payments';
            $notification['message'] = __("Sent new wallet withdrawal request");
            break;

          case 'wallet_withdrawal_approved':
            $notification['icon'] = "fa fa-exchange-alt";
            $notification['url'] = $system['system_url'] . '/comunidade/wallet/payments';
          ...
          case 'affiliates_withdrawal':
            $notification['icon'] = "fa fa-exchange-alt";
            $notification['url'] = $system['system_url'] . '/comunidade/' . $control_panel['url'] . '/affiliates/payments';
            $notification['message'] = __("Sent new affiliates withdrawal request");
            break;

          case 'affiliates_withdrawal_approved':
            $notification['icon'] = "fa fa-exchange-alt";
            $notification['url'] = $system['system_url'] . '/comunidade/settings/affiliates/payments';
          ...
          case 'points_withdrawal':
            ...
            $notification['url'] = $system['system_url'] . '/comunidade/' . $control_panel['url'] . '/points/payments';
            $notification['message'] = __("Sent new points withdrawal request");
            break;

          case 'points_withdrawal_approved':
            $notification['icon'] = "fa fa-exchange-alt";
            $notification['url'] = $system['system_url'] . '/comunidade/settings/points/payments';
          ...
          case 'funding_withdrawal':
            ...
            $notification['url'] = $system['system_url'] . '/comunidade/' . $control_panel['url'] . '/funding/payments';
            $notification['message'] = __("Sent new funding withdrawal request");
            break;

          case 'funding_withdrawal_approved':
            $notification['icon'] = "fa fa-hand-holding-usd";
            $notification['url'] = $system['system_url'] . '/comunidade/settings/funding';
          ...
          case 'ads_campaign_added':
            ...
            $notification['url'] = $system['system_url'] . '/comunidade/' . $control_panel['url'] . '/ads/users_ads';
          ...
          case 'ads_campaign_approved':
            $notification['icon'] = "fa fa-bullseye";
            $notification['url'] = $system['system_url'] . '/comunidade/ads';
          ...
          case 'report':
            $notification['icon'] = "fa fa-flag";
            $notification['url'] = $system['system_url'] . '/comunidade/' . $control_panel['url'] . '/reports';
            $notification['message'] = __("reported new content");
            break;

          case 'verification_request':
            $notification['icon'] = "fa fa-check-circle";
            $notification['url'] = $system['system_url'] . '/comunidade/' . $control_panel['url'] . '/verification';
          ...
          case 'async_request':
            ...
            $notification['url'] = $system['system_url'] . '/comunidade/' . $control_panel['url'];
            $notification['message'] = $notification['message'];
            break;
  ...
  public function post_notification($args = [])
  {
      ...
      switch ($action) {
        case 'friend_add':
          if ($system['email_friend_requests'] && $receiver['email_friend_requests']) {
            $notification['url'] = $system['system_url'] . '/comunidade/' . $node_url;
            $notification['message'] = __("sent you a friend request");
          }
          break;
        ...
        case 'react_angry':
          if ($system['email_post_likes'] && $receiver['email_post_likes']) {
            if ($node_type == "post") {
              $notification['url'] = $system['system_url'] . '/comunidade/posts/' . $node_url;
              $notification['message'] = __("reacted to your post");
            } elseif ($node_type == "photo") {
              $notification['url'] = $system['system_url'] . '/comunidade/photos/' . $node_url;
              $notification['message'] = __("reacted to your photo");
            } elseif ($node_type == "post_comment") {
              $notification['url'] = $system['system_url'] . '/comunidade/posts/' . $node_url . $notify_id;
              $notification['message'] = __("reacted to your comment");
            } elseif ($node_type == "photo_comment") {
              $notification['url'] = $system['system_url'] . '/comunidade/photos/' . $node_url . $notify_id;
              $notification['message'] = __("reacted to your comment");
        ...
        case 'profile_visit':
          if ($system['email_profile_visits'] && $receiver['email_profile_visits']) {
            $notification['url'] = $system['system_url'] . '/comunidade/' . $this->_data['user_name'];
            $notification['message'] = __("visited your profile");
          }
          break;
    ...
    if ($system['onesignal_notification_enabled'] && $receiver['onesignal_user_id']) {
      ...
      switch ($action) {
        ...
        case 'gift':
          $notification['url'] = $system['system_url'] . '/comunidade/' . $this->_data['user_name'] . '?gift=' . $node_url;
          $notification['message'] = __("Sent you a gift");
          break;
        ...
        case 'page_invitation':
          $notification['url'] = $system['system_url'] . '/comunidade/pages/' . $node_url;
        ...
        case 'group_join':
          $notification['url'] = $system['system_url'] . '/comunidade/groups/' . $node_url . '/settings/requests';
          $notification['message'] = __("asked to join your group") . " '" . html_entity_decode($node_type, ENT_QUOTES) . "'";
          break;

        case 'group_add':
          $notification['url'] = $system['system_url'] . '/comunidade/groups/' . $node_url;
        ...
        case 'group_post_pending':
          $notification['url'] = $system['system_url'] . '/comunidade/groups/' . $node_url . '?pending';
        ...
        case 'event_invitation':
          $notification['url'] = $system['system_url'] . '/comunidade/events/' . $node_url;
          $notification['message'] = __("invite you to join an event") . " '" . html_entity_decode($node_type, ENT_QUOTES) . "'";
          break;

        case 'event_post_pending':
          $notification['url'] = $system['system_url'] . '/comunidade/events/' . $node_url . '?pending';
        ...
        case 'forum_reply':
          $notification['url'] = $system['system_url'] . '/comunidade/forums/thread/' . $node_url;
          $notification['message'] = __("replied to your thread");
          break;
  ...
  function decode_hashtags($text, $trending_hashtags, $post_id)
  {
    ...
    $text = preg_replace_callback($pattern, function ($matches) use ($trending_hashtags, $post_id) {
      ...
      return $matches[1] . '<a href="' . $system['system_url'] . '/comunidade/search/hashtag/' . $matches[4] . '">' . $matches[2] . '</a>';
    }, $text);
    return $text;
  }
  ...
  public function publisher($args = [])
  {
    ...
    $post['post_author_url'] = $system['system_url'] . '/comunidade/' . $this->_data['user_name'];
    ...
    if ($args['handle'] == "user") {
      ...
      $post['post_author_url'] = $system['system_url'] . '/comunidade/pages/' . $_page['page_name'];
    ...
    switch ($post['post_type']) {
      ...
      case 'file':
        foreach ($args['file'] as $file) {
          ...
          $post_file['file_id'] = $db->insert_id;
          $post_file['source'] = $file['source'];
          $post['files'][] = $post_file;
        }
        $post['files_num'] = count($post['files']);
        break;
    }
    ...
    switch ($get) {
              ...
              if ($this->_logged_in) {
                if($this->_is_admin) {
                  ...
                  $where_query .= "1=1";
                    ...
                    /* [7] get posts from friends still followed */
                    /* viewer admin */
                    $where_query .= sprintf(" OR (posts.user_id IN (%s) AND posts.user_type = 'user' AND posts.in_group = '0' AND posts.in_event = '0')", 1);
      ...
      case 'posts_profile':
        ...
        if ($this->_logged_in) {
          ...
          if ($id == $this->_data['user_id'] || ($this->_is_admin)) {
            /* get all posts */
            $where_query .= "WHERE (";
  ...
  public function get_post($post_id, $get_comments = true, $pass_privacy_check = false)
  {
    ...
    switch ($post['post_type']) {
      ...
      case 'file':
        ...
        while ($post_file = $get_file->fetch_assoc()) {
          $post['file'][] = $post_file;
        }
        break;
  ...
  private function _check_post($id, $pass_privacy_check = false, $full_details = true)
  {
    ...
    if ($post['user_type'] == "user") {
      ...
      $post['post_author_url'] = $system['system_url'] . '/comunidade/' . $post['user_name'];
      ...
      $post['post_author_url'] = $system['system_url'] . '/comunidade/pages/' . $post['page_name'];
  ...
  public function get_comments($node_id, $offset = 0, $is_post = true, $pass_privacy_check = true, $post = [], $sorting = "recent", $last_comment_id = null)
  {
    ...
    while ($comment = $get_comments->fetch_assoc()) {
      ...
      if ($comment['user_type'] == "user") {
        ...
        $comment['author_url'] = $system['system_url'] . '/comunidade/' . $comment['user_name'];
        ...
        $comment['author_url'] = $system['system_url'] . '/comunidade/pages/' . $comment['page_name'];
  ...
  public function get_replies($comment_id, $offset = 0, $pass_check = true, $post = [])
  {
    ...
    while ($reply = $get_replies->fetch_assoc()) {
      ...
      if ($reply['user_type'] == "user") {
        ...
        $reply['author_url'] = $system['system_url'] . '/comunidade/' . $reply['user_name'];
        ...
        $reply['author_url'] = $system['system_url'] . '/comunidade/pages/' . $reply['page_name'];
  ...
  public function comment($handle, $node_id, $message, $photo, $voice_note)
  {
    ...
    if (!$post['is_page_admin']) {
      ...
      $comment['author_url'] = $system['system_url'] . '/comunidade/' . $this->_data['user_name'];
      ...
      $comment['author_url'] = $system['system_url'] . '/comunidade/pages/' . $post['page_name'];
  ...
  public function get_album($album_id, $full_details = true)
  {
    ...
    if ($get_cover->num_rows == 0) {
      $album['cover']['source'] = $system['system_url'] . '/comunidade/content/themes/' . $system['theme'] . '/images/blank_album.png';
      $album['cover']['blur'] = 0;
    } else {
  ...
  public function get_page_invites($page_id, $offset = 0)
  {
    ...
    if($this->_is_admin)
    {
      $get_friends = $db->query(sprintf("SELECT users.user_id, users.user_name, users.user_firstname, users.user_lastname, users.user_gender, users.user_picture, users.user_subscribed, users.user_verified FROM users LEFT JOIN pages_likes ON users.user_id = pages_likes.user_id AND pages_likes.page_id = %s LEFT JOIN pages_invites ON users.user_id = pages_invites.user_id AND pages_invites.page_id = %s AND pages_invites.from_user_id = %s WHERE pages_likes.id IS NULL AND pages_invites.id IS NULL LIMIT %s, %s", secure($page_id, 'int'), secure($page_id, 'int'), secure($this->_data['user_id'], 'int'), secure($offset, 'int', false), secure($system['max_results_even'], 'int', false))) or _error("SQL_ERROR_THROWEN");
    }
    else
    {
  ...
  public function get_group_invites($group_id, $offset = 0)
  {
    ...
    if($this->_is_admin)
    {
      $get_friends = $db->query(sprintf("SELECT users.user_id, users.user_name, users.user_firstname, users.user_lastname, users.user_gender, users.user_picture, users.user_subscribed, users.user_verified FROM users LEFT JOIN groups_members ON users.user_id = groups_members.user_id AND groups_members.group_id = %s WHERE groups_members.id IS NULL LIMIT %s, %s", secure($group_id, 'int'), secure($offset, 'int', false), secure($system['max_results_even'], 'int', false))) or _error("SQL_ERROR_THROWEN");
    }
    else
    {
  ...
  {
    global $db, $system;
    $get_requests = $db->query(sprintf("SELECT COUNT(*) as count FROM groups_members WHERE approved = '0' AND user_id <> 0 AND group_id = %s", secure($group_id, 'int'))) or _error("SQL_ERROR_THROWEN");
  ...
  public function get_event_invites($event_id, $offset = 0)
  {
    ...
    if($this->_is_admin)
    {
      $get_friends = $db->query(sprintf("SELECT users.user_id, users.user_name, users.user_firstname, users.user_lastname, users.user_gender, users.user_picture, users.user_subscribed, users.user_verified FROM users LEFT JOIN events_members ON users.user_id = events_members.user_id AND events_members.event_id = %s WHERE events_members.id IS NULL LIMIT %s, %s", secure($event_id, 'int'), secure($offset, 'int', false), secure($system['max_results_even'], 'int', false))) or _error("SQL_ERROR_THROWEN");
    }
    else
    {
  ...
  public function get_forum_threads($args = [])
  {
    ...
    if ($total_items > 0) {
      ...
      /* prepare pager URL */
      if ($forum !== null) {
        $params['url'] = $system['system_url'] . '/comunidade/forums/' . $forum['forum_id'] . '/' . $forum['title_url'] . '?page=%s';
      } elseif ($user_id !== null) {
        $params['url'] = $system['system_url'] . '/comunidade/forums/my-threads?page=%s';
      } elseif ($query !== null) {
  ...
  public function get_forum_replies($args = [])
  {
    ...
    if ($total_items > 0) {
      ...
      /* prepare pager URL */
      if ($thread !== null) {
        $params['url'] = $system['system_url'] . '/comunidade/forums/thread/' . $thread['thread_id'] . '/' . $thread['title_url'] . '?page=%s';
      } elseif ($user_id !== null) {
        $params['url'] = $system['system_url'] . '/comunidade/forums/my-replies?page=%s';
      } elseif ($query !== null) {
        $params['url'] = remove_querystring_var($_SERVER['REQUEST_URI'], 'page');
        $params['url'] = $params['url'] . '&page=%s';
      }
    ...
    if ($get_campaigns->num_rows > 0) {
      while ($campaign = $get_campaigns->fetch_assoc()) {
        ...
        switch ($campaign['ads_type']) {
          case 'page':
            $campaign['ads_url'] = $system['system_url'] . '/comunidade/pages/' . $campaign['page_name'];
            break;

          case 'group':
            $campaign['ads_url'] = $system['system_url'] . '/comunidade/groups/' . $campaign['group_name'];
            break;

          case 'event':
            $campaign['ads_url'] = $system['system_url'] . '/comunidade/events/' . $campaign['ads_event'];
            break;
        }
  ...
  public function coinpayments($handle, $price, $id = null, $package_name = null)
  {
    ...
    switch ($handle) {
      case 'packages':
        ...
        $URL['ipn'] = $system['system_url'] . "/comunidade/includes/ajax/payments/coinpayments_webhook.php?handle=packages&package_id=" . $id;
        break;
      ...
      case 'wallet':
        ...
        $URL['success'] = $system['system_url'] . "/settings/coinpayments";
        $URL['cancel'] = $system['system_url'];
        $URL['ipn'] = $system['system_url'] . "/comunidade/includes/ajax/payments/coinpayments_webhook.php?handle=wallet";
        break;
      ...
      case 'donate':
        ...
        $URL['success'] = $system['system_url'] . "/settings/coinpayments";
        $URL['cancel'] = $system['system_url'];
        $URL['ipn'] = $system['system_url'] . "/comunidade/includes/ajax/payments/coinpayments_webhook.php?handle=donate&post_id=" . $id;
        break;
  ...
  public function socail_login($provider, $user_profile)
  {
    ...
    if ($check_user->num_rows > 0) {
      ...
      if ($this->_logged_in) {
       ...
       redirect('/comunidade/settings/linked');
      } else {
