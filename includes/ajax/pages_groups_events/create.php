  ...
  switch ($_GET['type']) {
    case 'page':
      if ($_GET['do'] == "create") {
        ...
        // return
        $return['path'] = $system['system_url'] . '/comunidade/pages/' . $_POST['username'];
      } elseif ($_GET['do'] == "edit") {
        ...
        // return
        $return['path'] = $system['system_url'] . '/comunidade/pages/' . $page_name;
      }
      break;
    ...
    case 'group':
      if ($_GET['do'] == "create") {
        ...
        // return
        $return['path'] = $system['system_url'] . '/comunidade/groups/' . $_POST['username'];
      } elseif ($_GET['do'] == "edit") {
    ...
    case 'event':
      if ($_GET['do'] == "create") {
        ...
        // return
        $return['path'] = $system['system_url'] . '/comunidade/events/' . $event_id;
      } elseif ($_GET['do'] == "edit") {
        ...
        // return
        $return['path'] = $system['system_url'] . '/comunidade/events/' . $_GET['id'];
      }
      break;
