...
try {
  ...
  switch ($_GET['do']) {
    ...
    case 'accept_policy':
      ...
      {
        // return
        return_json(array('error' => true, 'message' => __("You need to accept the terms")));
      }
      break;
    ...
    case 'finish':
      ...
      // update user info
      $db->query(sprintf("UPDATE users SET user_started = '1', user_policy_verified = '1' WHERE user_id = %s", secure($user->_data['user_id'], 'int'))) or _error("SQL_ERROR_THROWEN");
