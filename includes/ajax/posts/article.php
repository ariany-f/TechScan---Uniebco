...
try {
  ...
  switch ($_GET['do']) {
    case 'create':
      ...
      // return
      $return['path'] = $system['system_url'] . '/comunidade/blogs/' . $post_id . '/' . get_url_text($_POST['title']);
      break;
    ...
    case 'edit':
      ...
      // return
      $return['path'] = $system['system_url'] . '/comunidade/blogs/' . $_GET['id'] . '/' . get_url_text($_POST['title']);
      break;
