...
function _email($email, $subject, $body_html, $body_plain, $is_html = true, $only_smtp = false)
{
  ...
  if ($system['email_smtp_enabled']) {
    ...
    if (!$result) {
      $db->query(sprintf("INSERT INTO email_logs (email_recipient, send_result, mail_subject, body, header, smtp_host, smtp_user) VALUES (%s, %s, %s, %s, %s, %s, %s)", secure($email), secure($mail->ErrorInfo), secure($subject), secure($body_plain), secure($header), secure($system['email_smtp_server']), secure($system['email_smtp_username']))) or _error("SQL_ERROR_THROWEN");
    ...
    $db->query(sprintf("INSERT INTO email_logs (email_recipient, send_result, mail_subject, body, header, smtp_host, smtp_user) VALUES (%s, %s, %s, %s, %s, %s, %s)", secure($email), secure($result), secure($subject), secure($body_plain), secure($header), secure($system['email_smtp_server']), secure($system['email_smtp_username']))) or _error("SQL_ERROR_THROWEN");
...
{
  global $system;
  $image_source = $system['system_url'] . '/comunidade/content/themes/' . $system['theme'] . '/images/og-image.png';
  $content = '{
        "requests":[
            {
                "image":{
...
function user_access($is_ajax = false, $bypass_subscription = false)
{
  ...
  if ($is_ajax) {
    ...
    if (!$user->_logged_in) {
      ...
      if ($system['getting_started'] && (!$user->_data['user_started'] or !$user->_data['user_policy_verified'])) {
       redirect('/comunidade/started');
      }
    }
  }
}
...
function page_header($title, $description = '', $image = '')
{
  ...
  if ($image == '') {
    if ($system['system_ogimage']) {
      ...
      $image = $system['system_url'] . '/comunidade/content/themes/' . $system['theme'] . '/images/og-image.png';
    }
  }
...
function get_picture($picture, $type)
{
  ...
  if ($picture == "") {
    switch ($type) {
      case 'page':
        $picture = $system['system_url'] . '/comunidade/content/themes/' . $system['theme'] . '/images/blank_page.png';
        break;

      case 'group':
        $picture = $system['system_url'] . '/comunidade/content/themes/' . $system['theme'] . '/images/blank_group.png';
        break;

      case 'event':
        $picture = $system['system_url'] . '/comunidade/content/themes/' . $system['theme'] . '/images/blank_event.png';
        break;

      case 'article':
        $picture = $system['system_url'] . '/comunidade/content/themes/' . $system['theme'] . '/images/blank_article.png';
        break;

      case 'movie':
        $picture = $system['system_url'] . '/comunidade/content/themes/' . $system['theme'] . '/images/blank_movie.png';
        break;

      case 'game':
        $picture = $system['system_url'] . '/comunidade/content/themes/' . $system['theme'] . '/images/blank_game.png';
        break;

      case 'package':
        $picture = $system['system_url'] . '/comunidade/content/themes/' . $system['theme'] . '/images/blank_package.png';
        break;

      case 'flag':
        $picture = $system['system_url'] . '/comunidade/content/themes/' . $system['theme'] . '/images/blank_flag.png';
        break;

      case 'system':
        $picture = $system['system_url'] . '/comunidade/content/themes/' . $system['theme'] . '/images/svg/dashboard.svg';
        break;

      case '1':
        $picture = $system['system_url'] . '/comunidade/content/themes/' . $system['theme'] . '/images/blank_profile_male.svg';
        break;

      case '2':
        $picture = $system['system_url'] . '/comunidade/content/themes/' . $system['theme'] . '/images/blank_profile_female.svg';
        break;

      default:
        $picture = $system['system_url'] . '/comunidade/content/themes/' . $system['theme'] . '/images/blank_profile.svg';
        break;
    }
  } else {
