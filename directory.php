...
try {
  ...
  switch ($_GET['view']) {
    ...
    case 'users':
      ...
      $params['url'] = $system['system_url'] . '/comunidade/directory/' . 'users' . '/%s';
    ...
    case 'posts':
      ...
      $params['total_items'] = $total->fetch_assoc()['count'];
      $params['items_per_page'] = $system['max_results'];
      $params['url'] = $system['system_url'] . '/comunidade/directory/' . 'posts' . '/%s';
      $pager = new Pager($params);
      $limit_query = $pager->getLimitSql();
    ...
    case 'pages':
      ...
      $params['total_items'] = $total->fetch_assoc()['count'];
      $params['items_per_page'] = $system['max_results'];
      $params['url'] = $system['system_url'] . '/comunidade/directory/' . 'pages' . '/%s';
      $pager = new Pager($params);
      $limit_query = $pager->getLimitSql();
    ...
    case 'groups':
      ...
      $params['total_items'] = $total->fetch_assoc()['count'];
      $params['items_per_page'] = $system['max_results'];
      $params['url'] = $system['system_url'] . '/comunidade/directory/' . 'groups' . '/%s';
      $pager = new Pager($params);
      $limit_query = $pager->getLimitSql();
    ...
    case 'events':
      ...
      $params['total_items'] = $total->fetch_assoc()['count'];
      $params['items_per_page'] = $system['max_results'];
      $params['url'] = $system['system_url'] . '/comunidade/directory/' . 'events' . '/%s';
      $pager = new Pager($params);
      $limit_query = $pager->getLimitSql();
    ...
    case 'games':
      ...
      $params['total_items'] = $total->fetch_assoc()['count'];
      $params['items_per_page'] = $system['max_results'];
      $params['url'] = $system['system_url'] . '/comunidade/directory/' . 'games' . '/%s';
      $pager = new Pager($params);
      $limit_query = $pager->getLimitSql();
