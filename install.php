...
(116, 'uploads_directory', 'comunidade/content/uploads'),
...
ALTER TABLE `widgets`
  ...
  $config_string = '<?php  
    ...
    ?>';
  $config_file = 'comunidade/includes/config.php';
...
<head>
  ...
  <link rel="shortcut icon" href="comunidade/includes/assets/js/core/installer/favicon.png" />
  ...
  <link rel="stylesheet" href="comunidade/includes/assets/js/core/installer/wizard.css">
</head>
...
<body>
  ...
  <script src="comunidade/includes/assets/js/core/installer/jquery.steps.min.js"></script>
