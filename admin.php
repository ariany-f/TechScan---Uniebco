    ...
    case 'users':
      ...
      switch ($_GET['sub_view']) {
        case '':
          ...
          $params['url'] = $system['system_url'] . '/comunidade/' . $control_panel['url'] . '/users?page=%s';
        ...
        case 'admins':
          ...
          $params['items_per_page'] = $system['max_results'];
          $params['url'] = $system['system_url'] . '/comunidade/' . $control_panel['url'] . '/users/admins?page=%s';
          $pager = new Pager($params);
          $limit_query = $pager->getLimitSql();
        ...
        case 'moderators':
          ...
          $params['total_items'] = $total->fetch_assoc()['count'];
          $params['items_per_page'] = $system['max_results'];
          $params['url'] = $system['system_url'] . '/comunidade/' . $control_panel['url'] . '/users/moderators?page=%s';
          $pager = new Pager($params);
          $limit_query = $pager->getLimitSql();
        ...
        case 'online':
          ...
          $params['total_items'] = $total->fetch_assoc()['count'];
          $params['items_per_page'] = $system['max_results'];
          $params['url'] = $system['system_url'] . '/comunidade/' . $control_panel['url'] . '/users/online?page=%s';
          $pager = new Pager($params);
          $limit_query = $pager->getLimitSql();
        ...
        case 'banned':
          ...
          $params['total_items'] = $total->fetch_assoc()['count'];
          $params['items_per_page'] = $system['max_results'];
          $params['url'] = $system['system_url'] . '/comunidade/' . $control_panel['url'] . '/users/banned?page=%s';
          $pager = new Pager($params);
          $limit_query = $pager->getLimitSql();
        ...
        case 'find':
          ...
          $params['total_items'] = $total->fetch_assoc()['count'];
          $params['items_per_page'] = $system['max_results'];
          $params['url'] = $system['system_url'] . '/comunidade/' . $control_panel['url'] . '/users/find?query=' . $_GET['query'] . '&page=%s';
          $pager = new Pager($params);
          $limit_query = $pager->getLimitSql();
    ...
    case 'posts':
      ...
      switch ($_GET['sub_view']) {
        case '':
          ...
          $params['items_per_page'] = $system['max_results'];
          $params['url'] = $system['system_url'] . '/comunidade/' . $control_panel['url'] . '/posts?page=%s';
          $pager = new Pager($params);
          $limit_query = $pager->getLimitSql();
          ...
          if ($get_rows->num_rows > 0) {
            while ($row = $get_rows->fetch_assoc()) {
              ...
              if ($row['user_type'] == "user") {
                ...
                $row['post_author_url'] = $system['system_url'] . '/comunidade/' . $row['user_name'];
                ...
                $row['post_author_url'] = $system['system_url'] . '/comunidade/pages/' . $row['page_name'];
        ...
        case 'find':
          ...
          $params['total_items'] = $total->fetch_assoc()['count'];
          $params['items_per_page'] = $system['max_results'];
          $params['url'] = $system['system_url'] . '/comunidade/' . $control_panel['url'] . '/posts/find?query=' . $_GET['query'] . '&page=%s';
          $pager = new Pager($params);
          $limit_query = $pager->getLimitSql();
    ...
    case 'pages':
      ...
      switch ($_GET['sub_view']) {
        case '':
          ...
          $params['items_per_page'] = $system['max_results'];
          $params['url'] = $system['system_url'] . '/comunidade/' . $control_panel['url'] . '/pages?page=%s';
          $pager = new Pager($params);
          $limit_query = $pager->getLimitSql();
        ...
        case 'find':
          ...
          $params['total_items'] = $total->fetch_assoc()['count'];
          $params['items_per_page'] = $system['max_results'];
          $params['url'] = $system['system_url'] . '/comunidade/' . $control_panel['url'] . '/pages/find?query=' . $_GET['query'] . '&page=%s';
          $pager = new Pager($params);
          $limit_query = $pager->getLimitSql();
    ...
    case 'groups':
      ...
      switch ($_GET['sub_view']) {
        case '':
          ...
          $params['total_items'] = $total->fetch_assoc()['count'];
          $params['items_per_page'] = $system['max_results'];
          $params['url'] = $system['system_url'] . '/comunidade/' . $control_panel['url'] . '/groups?page=%s';
          $pager = new Pager($params);
          $limit_query = $pager->getLimitSql();
        ...
        case 'find':
          ...
          $params['total_items'] = $total->fetch_assoc()['count'];
          $params['items_per_page'] = $system['max_results'];
          $params['url'] = $system['system_url'] . '/comunidade/' . $control_panel['url'] . '/groups/find?query=' . $_GET['query'] . '&page=%s';
          $pager = new Pager($params);
          $limit_query = $pager->getLimitSql();
    ...
    case 'events':
      ...
      switch ($_GET['sub_view']) {
        case '':
          ...
          $params['total_items'] = $total->fetch_assoc()['count'];
          $params['items_per_page'] = $system['max_results'];
          $params['url'] = $system['system_url'] . '/comunidade/' . $control_panel['url'] . '/events?page=%s';
          $pager = new Pager($params);
          $limit_query = $pager->getLimitSql();
        ...
        case 'find':
          ...
          $params['total_items'] = $total->fetch_assoc()['count'];
          $params['items_per_page'] = $system['max_results'];
          $params['url'] = $system['system_url'] . '/comunidade/' . $control_panel['url'] . '/events/find?query=' . $_GET['query'] . '&page=%s';
          $pager = new Pager($params);
          $limit_query = $pager->getLimitSql();
    ...
    case 'blogs':
      ...
      switch ($_GET['sub_view']) {
        case '':
          ...
          $params['total_items'] = $total->fetch_assoc()['count'];
          $params['items_per_page'] = $system['max_results'];
          $params['url'] = $system['system_url'] . '/comunidade/' . $control_panel['url'] . '/blogs?page=%s';
          $pager = new Pager($params);
          $limit_query = $pager->getLimitSql();
          ...
          if ($get_rows->num_rows > 0) {
            while ($row = $get_rows->fetch_assoc()) {
              ...
              $row['article_author_url'] = $system['system_url'] . '/comunidade/' . $row['user_name'];
        ...
        case 'find':
          ...
          $params['total_items'] = $total->fetch_assoc()['count'];
          $params['items_per_page'] = $system['max_results'];
          $params['url'] = $system['system_url'] . '/comunidade/' . $control_panel['url'] . '/blogs/find?query=' . $_GET['query'] . '&page=%s';
          $pager = new Pager($params);
          $limit_query = $pager->getLimitSql();
    ...
    case 'offers':
      ...
      switch ($_GET['sub_view']) {
        case '':
          ...
          $params['total_items'] = $total->fetch_assoc()['count'];
          $params['items_per_page'] = $system['max_results'];
          $params['url'] = $system['system_url'] . '/comunidade/' . $control_panel['url'] . '/offers?page=%s';
          $pager = new Pager($params);
          $limit_query = $pager->getLimitSql();
        ...
        case 'find':
          ...
          $params['total_items'] = $total->fetch_assoc()['count'];
          $params['items_per_page'] = $system['max_results'];
          $params['url'] = $system['system_url'] . '/comunidade/' . $control_panel['url'] . '/offers/find?query=' . $_GET['query'] . '&page=%s';
          $pager = new Pager($params);
          $limit_query = $pager->getLimitSql();
    ...
    case 'jobs':
      ...
      switch ($_GET['sub_view']) {
        case '':
          ...
          $params['total_items'] = $total->fetch_assoc()['count'];
          $params['items_per_page'] = $system['max_results'];
          $params['url'] = $system['system_url'] . '/comunidade/' . $control_panel['url'] . '/jobs?page=%s';
          $pager = new Pager($params);
          $limit_query = $pager->getLimitSql();
        ...
        case 'find':
          ...
          $params['total_items'] = $total->fetch_assoc()['count'];
          $params['items_per_page'] = $system['max_results'];
          $params['url'] = $system['system_url'] . '/comunidade/' . $control_panel['url'] . '/jobs/find?query=' . $_GET['query'] . '&page=%s';
          $pager = new Pager($params);
          $limit_query = $pager->getLimitSql();
    ...
    case 'forums':
      ...
      switch ($_GET['sub_view']) {
        ...
        case 'threads':
          ...
          $params['total_items'] = $total->fetch_assoc()['count'];
          $params['items_per_page'] = $system['max_results'];
          $params['url'] = $system['system_url'] . '/comunidade/' . $control_panel['url'] . '/forums/threads?page=%s';
          $pager = new Pager($params);
          $limit_query = $pager->getLimitSql();
          ...
          if ($get_rows->num_rows > 0) {
            while ($row = $get_rows->fetch_assoc()) {
              ...
              $row['thread_author_url'] = $system['system_url'] . '/comunidade/' . $row['user_name'];
        ...
        case 'find_threads':
          ...
          $params['total_items'] = $total->fetch_assoc()['count'];
          $params['items_per_page'] = $system['max_results'];
          $params['url'] = $system['system_url'] . '/comunidade/' . $control_panel['url'] . '/forums/find_threads?query=' . $_GET['query'] . '&page=%s';
          $pager = new Pager($params);
          $limit_query = $pager->getLimitSql();
        ...
        case 'replies':
          ...
          $params['total_items'] = $total->fetch_assoc()['count'];
          $params['items_per_page'] = $system['max_results'];
          $params['url'] = $system['system_url'] . '/comunidade/' . $control_panel['url'] . '/forums/replies?page=%s';
          $pager = new Pager($params);
          $limit_query = $pager->getLimitSql();
          ...
          if ($get_rows->num_rows > 0) {
            while ($row = $get_rows->fetch_assoc()) {
              ...
              $row['reply_author_url'] = $system['system_url'] . '/comunidade/' . $row['user_name'];
        ...
        case 'find_replies':
          ...
          $params['total_items'] = $total->fetch_assoc()['count'];
          $params['items_per_page'] = $system['max_results'];
          $params['url'] = $system['system_url'] . '/comunidade/' . $control_panel['url'] . '/forums/find_replies?query=' . $_GET['query'] . '&page=%s';
          $pager = new Pager($params);
          $limit_query = $pager->getLimitSql();
    ...
    case 'funding':
      ...
      switch ($_GET['sub_view']) {
        ...
        case 'requests':
          ...
          $params['total_items'] = $total->fetch_assoc()['count'];
          $params['items_per_page'] = $system['max_results'];
          $params['url'] = $system['system_url'] . '/comunidade/' . $control_panel['url'] . '/funding/requests?page=%s';
          $pager = new Pager($params);
          $limit_query = $pager->getLimitSql();
        ...
        case 'find':
          ...
          $params['total_items'] = $total->fetch_assoc()['count'];
          $params['items_per_page'] = $system['max_results'];
          $params['url'] = $system['system_url'] . '/comunidade/' . $control_panel['url'] . '/funding/find?query=' . $_GET['query'] . '&page=%s';
          $pager = new Pager($params);
          $limit_query = $pager->getLimitSql();
          ...
          if ($get_rows->num_rows > 0) {
            while ($row = $get_rows->fetch_assoc()) {
              ...
              if ($row['node_type'] == "user") {
                ...
                if (!$thread) continue;
                $row['url'] = $system['system_url'] . '/comunidade/forums/thread/' . $thread['thread_id'] . '/' . $thread['title_url'];
                $node['color'] = 'secondary';
                $node['name'] = __("Forum Thread");
              } elseif ($row['node_type'] == 'forum_reply') {
                $reply = $user->get_forum_reply($row['node_id']);
                if (!$reply) continue;
                $row['url'] = $system['system_url'] . '/comunidade/forums/thread/' . $reply['thread']['thread_id'] . '/' . $reply['thread']['title_url'] . '/#reply-' . $reply['reply_id'];
                $node['color'] = 'secondary';
