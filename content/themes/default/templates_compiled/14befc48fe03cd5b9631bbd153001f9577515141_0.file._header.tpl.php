<?php
/* Smarty version 4.2.0, created on 2024-11-26 15:38:44
  from 'E:\httpdocs\www\comunidade\content\themes\default\templates\_header.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.2.0',
  'unifunc' => 'content_6745eb84a7d179_19600423',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '14befc48fe03cd5b9631bbd153001f9577515141' => 
    array (
      0 => 'E:\\httpdocs\\www\\comunidade\\content\\themes\\default\\templates\\_header.tpl',
      1 => 1732635316,
      2 => 'file',
    ),
  ),
...
function content_6745eb84a7d179_19600423 (Smarty_Internal_Template $_smarty_tpl) {
if (!$_smarty_tpl->tpl_vars['user']->value->_logged_in) {?>

    <body data-view="<?php echo $_smarty_tpl->tpl_vars['page']->value;?>
" data-hash-tok="<?php echo $_smarty_tpl->tpl_vars['session_hash']->value['token'];?>
...
/comunidade/admincp/settings"><?php echo __("Admin Panel");?>
</a>
          </div>
        </div>
        <!-- top-bar alert-->
...
">
                    <?php } else { ?>
                      <img class="img-fluid" src="content/themes/default/images/home/logo_white.png" alt="<?php echo __($_smarty_tpl->tpl_vars['system']->value['system_title']);?>
" title="<?php echo __($_smarty_tpl->tpl_vars['system']->value['system_title']);?>
">
                    <?php }?>
                  <?php } else { ?>
...
">
                          ...
                          <div class="dropdown-menu dropdown-menu-right">
                            <?php if ($_smarty_tpl->tpl_vars['system']->value['packages_enabled'] && !$_smarty_tpl->tpl_vars['user']->value->_data['user_subscribed']) {?>
                              <a class="dropdown-item" href="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
/comunidade/packages"><?php echo __("Upgrade to Pro");?>
</a>
                            <?php }?>
                            <?php if ($_smarty_tpl->tpl_vars['system']->value['points_enabled'] || $_smarty_tpl->tpl_vars['system']->value['wallet_enabled'] || $_smarty_tpl->tpl_vars['user']->value->_data['can_raise_funding']) {?>
                              <?php if ($_smarty_tpl->tpl_vars['system']->value['points_enabled']) {?>
                                <a class="dropdown-item" href="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
/comunidade/settings/points"><?php echo __("Points");?>
: <span class="badge badge-info"><?php echo $_smarty_tpl->tpl_vars['user']->value->_data['user_points'];?>
                              ...
                              <?php if ($_smarty_tpl->tpl_vars['system']->value['wallet_enabled']) {?>
                                <a class="dropdown-item" href="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
/comunidade/wallet"><?php echo __("Wallet");?>
: <span class="badge badge-success"><?php echo print_money(number_format($_smarty_tpl->tpl_vars['user']->value->_data['user_wallet_balance'],2));?>
                              ...
                              <?php if ($_smarty_tpl->tpl_vars['user']->value->_data['can_raise_funding']) {?>
                                <a class="dropdown-item" href="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
/comunidade/settings/funding"><?php echo __("Funding");?>
...
"><?php echo __("Profile");?>
                            ...
                            <a class="dropdown-item" href="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
/comunidade/settings"><?php echo __("Settings");?>
</a>
                            <a class="dropdown-item" href="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
/comunidade/settings/privacy"><?php echo __("Privacy");?>
</a>
                            <?php if ($_smarty_tpl->tpl_vars['user']->value->_is_admin) {?>
                              <div class="dropdown-divider"></div>
                              <a class="dropdown-item" href="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
/comunidade/admincp"><?php echo __("Admin Panel");?>
</a>
                            <?php } elseif ($_smarty_tpl->tpl_vars['user']->value->_is_moderator) {?>
                              <div class="dropdown-divider"></div>
                              <a class="dropdown-item" href="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
/comunidade/modcp"><?php echo __("Moderator Panel");?>
</a>
                            <?php }?>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
/comunidade/signout"><?php echo __("Log Out");?>
</a>
                            <div class="dropdown-divider"></div>
                      ...
                      <?php } else { ?>
                        <?php if ($_smarty_tpl->tpl_vars['user']->value->_logged_in) {?>
                          <li class="dropdown float-right">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                              <a class="dropdown-item" href="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
/comunidade/signin"><?php echo __("Login");?>
</a>
                              <?php if ($_smarty_tpl->tpl_vars['system']->value['registration_enabled']) {?>
                                <a class="dropdown-item" href="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
/comunidade/signup"><?php echo __("Register");?>
</a>
                              <?php }?>
