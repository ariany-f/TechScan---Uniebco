...
/comunidade/content/themes/<?php echo $_smarty_tpl->tpl_vars['theme']->value['name'];?>
...
/comunidade/search/{{#hashtag}}hashtag/{{/hashtag}}{{query}}"><i class="fa fa-search pr5"></i> <?php echo __("Search for");?>
...
/comunidade/messages/new"><i class="fa fa-edit"></i></a><i class="fa fa-cog" data-toggle="dropdown" data-display="static"></i><div class="dropdown-menu dropdown-menu-right"><a class="dropdown-item" href="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
/comunidade/settings/blocking"><?php echo __("Manage Blocking");?>
</a><a class="dropdown-item" href="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
/comunidade/settings/privacy"><?php echo __("Privacy Settings");?>
...
/comunidade/{{link}}" title="{{name_list}}">{{name}}</a>{{/multiple}}{{#multiple}}<a href="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
/comunidade/messages/{{link}}" title="{{name_list}}">{{name}}</a>{{/multiple}}<!-- label --><div class="chat-head-label"><span class="badge badge-pill badge-lg badge-danger js_chat-box-label"></span></div><!-- label --><!-- buttons--><div class="float-right"><!-- video/audio calls (not multiple) -->{{^multiple}}<?php if ($_smarty_tpl->tpl_vars['system']->value['audio_call_enabled'] && $_smarty_tpl->tpl_vars['user']->value->_data['can_start_audio_call']) {?><i class="fa fa-phone-alt mr10 js_chat-call-start" data-type="audio" data-uid="{{user_id}}" data-name="{{name_list}}"></i><?php }
...
/comunidade/settings/download?hash=<?php echo $_smarty_tpl->tpl_vars['user']->value->_data['user_name'];?>
