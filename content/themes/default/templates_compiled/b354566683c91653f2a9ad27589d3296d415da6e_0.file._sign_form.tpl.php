<?php
/* Smarty version 4.2.0, created on 2023-03-07 04:20:11
  from 'E:\httpdocs\www\comunidade\content\themes\default\templates\_sign_form.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.2.0',
  'unifunc' => 'content_6406bb7bb74f57_81505278',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'b354566683c91653f2a9ad27589d3296d415da6e' => 
    array (
      0 => 'E:\\httpdocs\\www\\comunidade\\content\\themes\\default\\templates\\_sign_form.tpl',
      1 => 1678161461,
      2 => 'file',
    ),
  ),
...
function content_6406bb7bb74f57_81505278 (Smarty_Internal_Template $_smarty_tpl) {
?><div class="card card-register">

  <!-- signin -->
  <div class="js_panel <?php if ($_smarty_tpl->tpl_vars['do']->value == 'up') {?>x-hidden<?php }?>">
    <div class="card-header">
      <h3 class="mt-5 ml-5 card-title">ENTRAR</h3>
    </div>
    <div class="card-body">
...
/comunidade/reset"><?php echo __("Forgotten password?");?>
</a>
        </div>
        <div class="form-group">
          <button type="submit" class="btn btn-block btn-login border-0 bg-gradient-login"><?php echo __("Login");?>
</button>
        </div>
        <!-- error -->
...
/comunidade/connect/facebook" class="btn btn-sm btn-rounded btn-social-icon btn-facebook">
                <i class="fab fa-facebook-f"></i>
              </a>
            <?php }?>
            <?php if ($_smarty_tpl->tpl_vars['system']->value['google_login_enabled']) {?>
              <a href="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
/comunidade/connect/google" class="btn btn-sm btn-rounded btn-social-icon btn-google">
                <i class="fab fa-google"></i>
              </a>
            <?php }?>
            <?php if ($_smarty_tpl->tpl_vars['system']->value['twitter_login_enabled']) {?>
              <a href="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
/comunidade/connect/twitter" class="btn btn-sm btn-rounded btn-social-icon btn-twitter">
                <i class="fab fa-twitter"></i>
              </a>
            <?php }?>
            <?php if ($_smarty_tpl->tpl_vars['system']->value['linkedin_login_enabled']) {?>
              <a href="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
/comunidade/connect/linkedin" class="btn btn-sm btn-rounded btn-social-icon btn-linkedin">
                <i class="fab fa-linkedin"></i>
              </a>
            <?php }?>
            <?php if ($_smarty_tpl->tpl_vars['system']->value['vkontakte_login_enabled']) {?>
              <a href="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
/comunidade/connect/vkontakte" class="btn btn-sm btn-rounded btn-social-icon btn-vk">
                <i class="fab fa-vk"></i>
              </a>
            <?php }?>
          </div>
 ...
 <a href="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
/comunidade/signup" class="js_toggle-panel text-link"><?php echo __("Create an account");?>
</a>
        </div>
      <?php }?>
    </div>
...
/comunidade/static/privacy" target="_blank"><?php echo __("Privacy Policy");?>
        ...
        <div class="form-group">
          <button type="submit" class="btn btn-login btn-block bg-gradient-login border-0"><?php echo __("Sign Up");?>
</button>
        </div>
        <!-- error -->
        <div class="alert alert-danger mb0 x-hidden"></div>
...
/comunidade/connect/vkontakte" class="btn btn-sm btn-rounded btn-social-icon btn-vk">
 ...
 <a href="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
/comunidade/signin" class="js_toggle-panel text-link"><?php echo __("Login Now");?>
</a>
      </div>
    </div>
  </div>
