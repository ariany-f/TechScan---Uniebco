...
<div class="page-header">
  <img class="floating-img d-none d-md-block" src="{$system['system_url']}/comunidade/content/themes/{$system['theme']}/images/headers/undraw_movie_night_fldd.svg">
...
<div class="container offcanvas">
  <div class="row">
    ...
    <!-- left panel -->
    <div class="col-md-4 col-lg-2 offcanvas-sidebar">
      <!-- genres -->
      <div class="card">
          ...
          <ul class="side-nav">
            ...
            {foreach $genres as $_genre}
              <li {if $view == "genre" && $genre['genre_id'] == $_genre['genre_id']}class="active" {/if}>
                <a href="{$system['system_url']}/comunidade/movies/genre/{$_genre['genre_id']}/{$_genre['genre_url']}">
      ...
      {if $view == "movie"}
        ...
        <div class="article-wrapper" style="border-radius: 3px;">
          ...
          <div class="mt10">
            ...
            <a href="http://www.facebook.com/sharer.php?u={$system['system_url']}/comunidade/movie/{$movie['movie_id']}/{$movie['movie_url']}" class="btn btn-sm btn-rounded btn-social-icon btn-facebook" target="_blank">
              <i class="fab fa-facebook-f"></i>
            </a>
            <a href="https://twitter.com/intent/tweet?url={$system['system_url']}/comunidade/movie/{$movie['movie_id']}/{$movie['movie_url']}" class="btn btn-sm btn-rounded btn-social-icon btn-rounded btn-twitter" target="_blank">
              <i class="fab fa-twitter"></i>
            </a>
            <a href="https://vk.com/share.php?url={$system['system_url']}/comunidade/movie/{$movie['movie_id']}/{$movie['movie_url']}" class="btn btn-sm btn-rounded btn-social-icon btn-vk" target="_blank">
              <i class="fab fa-vk"></i>
            </a>
            <a href="https://www.linkedin.com/shareArticle?mini=true&url={$system['system_url']}/comunidade/movie/{$movie['movie_id']}/{$movie['movie_url']}" class="btn btn-sm btn-rounded btn-social-icon btn-linkedin" target="_blank">
              <i class="fab fa-linkedin"></i>
            </a>
            <a href="https://api.whatsapp.com/send?text={$system['system_url']}/comunidade/movie/{$movie['movie_id']}/{$movie['movie_url']}" class="btn btn-sm btn-rounded btn-social-icon btn-whatsapp d-none d-sm-inline-block" target="_blank">
              <i class="fab fa-whatsapp"></i>
            </a>
            <a href="https://reddit.com/submit?url={$system['system_url']}/comunidade/movie/{$movie['movie_id']}/{$movie['movie_url']}" class="btn btn-sm btn-rounded btn-social-icon btn-reddit" target="_blank">
              <i class="fab fa-reddit"></i>
            </a>
            <a href="https://pinterest.com/pin/create/button/?url={$system['system_url']}/comunidade/movie/{$movie['movie_id']}/{$movie['movie_url']}" class="btn btn-sm btn-rounded btn-social-icon btn-pinterest" target="_blank">
            ...
            {foreach $movies as $_movie}
              <li class="col-sm-6 col-md-6 col-lg-4">
                <div class="movie-card">
                  <a href="{$system['system_url']}/comunidade/movie/{$_movie['movie_id']}/{$_movie['movie_url']}" class="movie-card-top">
                  ...
                  <div class="movie-card-bottom">
                    <a href="{$system['system_url']}/comunidade/movie/{$_movie['movie_id']}/{$_movie['movie_url']}" class="movie-title">{$_movie['title']}</a>
