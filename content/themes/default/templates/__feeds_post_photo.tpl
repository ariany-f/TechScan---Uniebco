...
<div class="post-body {if $_lightbox}pt0{/if}">
  ...
  <div class="post-header">
    ...
    <div class="post-meta">
      ...
      <div class="post-time">
        <a href="{$system['system_url']}/comunidade/posts/{$post['post_id']}" class="js_moment" data-time="{$post['time']}">{$post['time']}</a>
    ...
    <div class="mt10 clearfix">
      <div class="pg_wrapper">
        <div class="pg_1x {if $photo['blur']}x-blured{/if}">
          <a href="{$system['system_url']}/comunidade/photos/{$photo['photo_id']}" class="js_lightbox" data-id="{$photo['photo_id']}" data-image="{$system['system_uploads']}/{$photo['source']}" data-context="{if $photo['is_single']}album{else}post{/if}">
