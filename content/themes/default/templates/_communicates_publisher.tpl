...
<div class="x-form publisher communicates" data-handle="{$_handle}" {if $_id}data-id="{$_id}" {/if}>
    ...
    <div class="publisher-tools-tabs">
      ...
      <ul class="row">
        {if $user->_data['can_go_live']}
          <li class="col-md-6">
            <a class="publisher-tools-tab link js_publisher-tab" data-tab="live" href="{$system['system_url']}/comunidade/live{if $_handle == "page"}?page_id={$_id}{/if}{if $_handle == "group"}?group_id={$_id}{/if}{if $_handle == "event"}?event_id={$_id}{/if}">
        ...
        {if $system['photos_enabled']}
          <li class="col-md-6">
            <div class="publisher-tools-tab attach js_publisher-tab" data-tab="photos">
              <img src="{$system['system_url']}/comunidade/content/themes/{$system['theme']}/images/svg/camera.svg" class="js_x-uploader" data-handle="publisher" data-multiple="true">
              {__("Upload Photos")}
            </div>
          </li>
          <li class="col-md-6">
        ...
        {if $user->_data['can_write_articles']}
          <li class="col-md-6">
            <a class="publisher-tools-tab link js_publisher-tab" data-tab="article" href='{$system['system_url']}/comunidade/blogs/new{if $_handle == "page"}?page={$_id}{/if}{if $_handle == "group"}?group={$_id}{/if}{if $_handle == "event"}?event={$_id}{/if}'>
        ...
        {if $system['videos_enabled']}
          <li class="col-md-6">
            <div class="publisher-tools-tab attach js_publisher-tab" data-tab="video">
              <img src="{$system['system_url']}/comunidade/content/themes/{$system['theme']}/images/svg/video_camera.svg" class="js_x-uploader" data-handle="publisher" data-type="video">
              {__("Upload Video")}
            </div>
          </li>
        {/if}
        {if $system['audio_enabled']}
          <li class="col-md-6">
            <div class="publisher-tools-tab attach js_publisher-tab" data-tab="audio">
              <img src="{$system['system_url']}/comunidade/content/themes/{$system['theme']}/images/svg/music_file.svg" class="js_x-uploader" data-handle="publisher" data-type="audio">
              {__("Upload Audio")}
            </div>
          </li>
        {/if}
        {if $system['file_enabled']}
          <li class="col-md-6">
            <div class="publisher-tools-tab attach js_publisher-tab" data-tab="file">
              <img src="{$system['system_url']}/comunidade/content/themes/{$system['theme']}/images/svg/folder.svg" class="js_x-uploader" data-handle="publisher" data-type="file" data-multiple="true">
              {__("Upload File")}
            </div>
          </li>
        {/if}
