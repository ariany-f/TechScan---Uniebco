{strip}
  ...
  <script>
    ...
    var ajax_path = site_path + "/comunidade/includes/ajax/";
  ...
  <script src="{$system['system_url']}/comunidade/node_modules/mustache/mustache.min.js" {if !$user->_logged_in}defer{/if}>
    
  </script>
  <script src="{$system['system_url']}/comunidade/node_modules/jquery-form/dist/jquery.form.min.js" {if !$user->_logged_in}defer{/if}>
    
  </script>
  <script src="{$system['system_url']}/comunidade/node_modules/jquery-inview/jquery.inview.min.js" {if !$user->_logged_in}defer{/if}>
    
  </script>
  <script src="{$system['system_url']}/comunidade/node_modules/autosize/dist/autosize.min.js" {if !$user->_logged_in}defer{/if}>
    
  </script>
  <script src="{$system['system_url']}/comunidade/node_modules/readmore-js/readmore.min.js" {if !$user->_logged_in}defer{/if}>
    
  </script>
  <script src="{$system['system_url']}/comunidade/node_modules/moment/min/moment-with-locales.min.js" {if !$user->_logged_in}defer{/if}>
  ...
  {if $system['auto_play_videos']}
    <script src="{$system['system_url']}/comunidade/node_modules/jquery-fracs/dist/jquery.fracs.min.js" {if !$user->_logged_in}defer{/if}>
  ...
  {if $user->_logged_in}
    ...
    <script src="{$system['system_url']}/comunidade/node_modules/triggeredautocomplete/jquery-ui.triggeredAutocomplete.js"></script>
    <!-- jQuery-UI -->

    <!-- Sticky Sidebar -->
    <script src="{$system['system_url']}/comunidade/node_modules/theia-sticky-sidebar/dist/theia-sticky-sidebar.min.js"></script>
    <!-- Sticky Sidebar -->

    <!-- Slick Slider -->
    {if $page == "index"}
      <script src="{$system['system_url']}/comunidade/node_modules/slick-carousel/slick/slick.min.js"></script>
      <link rel="stylesheet" type='text/css' href="{$system['system_url']}/comunidade/node_modules/slick-carousel/slick/slick.css">
      <link rel="stylesheet" type='text/css' href="{$system['system_url']}/comunidade/node_modules/slick-carousel/slick/slick-theme.css">
    {/if}
    <!-- Slick Slider -->
    ...
    {if $system['noty_notifications_enabled']}
      <script src="{$system['system_url']}/comunidade/node_modules/noty/lib/noty.min.js"></script>
      <link rel="stylesheet" type='text/css' href="{$system['system_url']}/comunidade/node_modules/noty/lib/noty.css">
    {/if}
    <!-- Noty Notifications -->

    <!-- Crop Profile Picture & Reposition Cover Photo -->
    {if $page == "started" || $page == "profile" || $page == "page" || $page == "group" || $page == "event"}
      <script src="{$system['system_url']}/comunidade/node_modules/jquery-ui-touch-punch/jquery.ui.touch-punch.min.js"></script>
      <script src="{$system['system_url']}/comunidade/node_modules/JQ-Image-Drag/script/jquery.imagedrag.min.js"></script>
      <script src="{$system['system_url']}/comunidade/node_modules/rcrop/dist/rcrop.min.js"></script>
      <link rel="stylesheet" type='text/css' href="{$system['system_url']}/comunidade/node_modules/rcrop/dist/rcrop.min.css">
    {/if}
    <!-- Crop Profile Picture & Reposition Cover Photo -->

    <!-- Stories -->
    {if $page == "index" && $view == ""}
      <script src="{$system['system_url']}/comunidade/node_modules/zuck.js/dist/zuck.min.js"></script>
      <link rel="stylesheet" type='text/css' href="{$system['system_url']}/comunidade/node_modules/zuck.js/dist/zuck.min.css">
    {/if}
    <!-- Stories -->

    <!-- Voice Notes -->
    {if $system['voice_notes_posts_enabled'] || $system['voice_notes_comments_enabled'] || $system['voice_notes_chat_enabled']}
      <script src="{$system['system_url']}/comunidade/node_modules/web-audio-recorder-js/lib-minified/WebAudioRecorder.min.js"></script>
    {/if}
    <!-- Voice Notes -->

    <!-- TinyMCE -->
    {if $page == "admin" || $page == "blogs" || $page == "forums"}
      <script src="{$system['system_url']}/comunidade/node_modules/tinymce/tinymce.min.js"></script>
    {/if}
    <!-- TinyMCE -->

    <!-- Bootstrap selectpicker -->
    <script src="{$system['system_url']}/comunidade/node_modules/bootstrap-select/dist/js/bootstrap-select.min.js"></script>
    ...
    {if $system['audio_call_enabled'] || $system['video_call_enabled'] || $system['voice_notes_posts_enabled'] || $system['voice_notes_comments_enabled'] || $system['voice_notes_chat_enabled']}
      <script src="{$system['system_url']}/comunidade/node_modules/easytimer.js/dist/easytimer.min.js"></script>
    {/if}
    <!-- Easytimer -->
  ...
  <!-- Sngine [JS] -->
  <script src="{$system['system_url']}/comunidade/includes/assets/js/core/core.js?v={$system['timestamp']}" {if !$user->_logged_in}defer{/if}>
    
  </script>
  {if $user->_logged_in}
    <script src="{$system['system_url']}/comunidade/includes/assets/js/core/user.js?v={$system['timestamp']}"></script>
    <script src="{$system['system_url']}/comunidade/includes/assets/js/core/post.js?v={$system['timestamp']}"></script>
    <script src="{$system['system_url']}/comunidade/includes/assets/js/core/chat.js?v={$system['timestamp']}"></script>
    <script src="{$system['system_url']}/comunidade/includes/assets/js/core/ad_code.js?v={$system['timestamp']}"></script>
    {if $system['live_enabled'] && $page == "live"}
      <script src="{$system['system_url']}/comunidade/includes/assets/js/core/live.js"></script>
    {/if}
  {else}
    <script src="{$system['system_url']}/comunidade/includes/assets/js/core/login.js?v={$system['timestamp']}" defer></script>
  {/if}
  <!-- Sngine [JS] -->

  {if $page == "admin"}
    <!-- Dependencies Plugins -->
    <script src="{$system['system_url']}/comunidade/node_modules/bootstrap-colorpicker/dist/js/bootstrap-colorpicker.min.js"></script>
    <link rel="stylesheet" type='text/css' href="{$system['system_url']}/comunidade/node_modules/bootstrap-colorpicker/dist/css/bootstrap-colorpicker.min.css">

    <script src="{$system['system_url']}/comunidade/node_modules/jquery-treegrid/js/jquery.treegrid.min.js"></script>
    <link rel="stylesheet" type='text/css' href="{$system['system_url']}/comunidade/node_modules/jquery-treegrid/css/jquery.treegrid.css">
