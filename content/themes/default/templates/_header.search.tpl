<div class="search-wrapper d-none d-md-block">
  <form>
    ...
    <div id="search-results" class="dropdown-menu dropdown-widget dropdown-search js_dropdown-keepopen">
      ...
      <a class="dropdown-widget-footer" id="search-results-all" href="{$system['system_url']}/comunidade/search/">{__("See All Results")}</a>
    </div>
    {if $user->_logged_in && $user->_data['search_log']}
      <div id="search-history" class="dropdown-menu dropdown-widget dropdown-search js_dropdown-keepopen">
        ...
        <a class="dropdown-widget-footer" id="search-results-all" href="{$system['system_url']}/comunidade/search/">{__("Advanced Search")}</a>
      </div>
    {/if}
  </form>
</div>