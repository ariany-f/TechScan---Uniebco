<div class="card">
  <div class="card-header with-icon">
    ...
    {elseif $sub_view == "categories"}
      <div class="float-right">
        <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/reports/add_category" class="btn btn-sm btn-primary">
    ...
    {elseif $sub_view == "add_category" || $sub_view == "edit_category"}
      <div class="float-right">
        <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/reports/categories" class="btn btn-sm btn-light">
              ...
              <tr>
                ...
                <td>
                  {if $row['node_type'] == "user"}
                    <a target="_blank" href="{$system['system_url']}/comunidade/{$row['node']['user_name']}">
                  ...
                  {elseif $row['node_type'] == "page"}
                    <a target="_blank" href="{$system['system_url']}/comunidade/pages/{$row['node']['page_name']}">
                      <img class="tbl-image" src="{$row['node']['page_picture']}">
                      {$row['node']['page_title']}
                    </a>
                  {elseif $row['node_type'] == "group"}
                    <a target="_blank" href="{$system['system_url']}/comunidade/groups/{$row['node']['group_name']}">
                      <img class="tbl-image" src="{$row['node']['group_picture']}">
                      {$row['node']['group_title']}
                    </a>
                  {elseif $row['node_type'] == "event"}
                    <a target="_blank" href="{$system['system_url']}/comunidade/events/{$row['node_id']}">
                      <img class="tbl-image" src="{$row['node']['event_picture']}">
                      {$row['node']['event_title']}
                    </a>
                  {elseif $row['node_type'] == "post"}
                    <a class="btn btn-sm btn-light" href="{$system['system_url']}/comunidade/posts/{$row['node_id']}" target="_blank">
                ...
                <td>
                  <a target="_blank" href="{$system['system_url']}/comunidade/{$row['user_name']}">
                ...
                <td>
                  {if $row['node_type'] == "user"}
                    <a data-toggle="tooltip" data-placement="top" title='{__("Edit")}' target="_blank" href="{$system['system_url']}/comunidade/{$control_panel['url']}/users/edit/{$row['node_id']}" class="btn btn-sm btn-icon btn-rounded btn-primary">
                      <i class="fa fa-pencil-alt"></i>
                    </a>
                  {elseif $row['node_type'] == "page"}
                    <a data-toggle="tooltip" data-placement="top" title='{__("Edit")}' target="_blank" href="{$system['system_url']}/comunidade/{$control_panel['url']}/pages/edit_page/{$row['node_id']}" class="btn btn-sm btn-icon btn-rounded btn-primary">
                      <i class="fa fa-pencil-alt"></i>
                    </a>
                  {elseif $row['node_type'] == "group"}
                    <a data-toggle="tooltip" data-placement="top" title='{__("Edit")}' target="_blank" href="{$system['system_url']}/comunidade/{$control_panel['url']}/groups/edit_group/{$row['node_id']}" class="btn btn-sm btn-icon btn-rounded btn-primary">
                      <i class="fa fa-pencil-alt"></i>
                    </a>
                  {elseif $row['node_type'] == "event"}
                    <a data-toggle="tooltip" data-placement="top" title='{__("Edit")}' target="_blank" href="{$system['system_url']}/comunidade/{$control_panel['url']}/events/edit_event/{$row['node_id']}" class="btn btn-sm btn-icon btn-rounded btn-primary">
                      <i class="fa fa-pencil-alt"></i>
                    </a>
                  {elseif $row['node_type'] == "forum_thread"}
                    <a data-toggle="tooltip" data-placement="top" title='{__("Edit")}' target="_blank" href="{$system['system_url']}/comunidade/forums/edit-thread/{$row['node_id']}" class="btn btn-sm btn-icon btn-rounded btn-primary">
                      <i class="fa fa-pencil-alt"></i>
                    </a>
                  {elseif $row['node_type'] == "forum_reply"}
                    <a data-toggle="tooltip" data-placement="top" title='{__("Edit")}' target="_blank" href="{$system['system_url']}/comunidade/forums/edit-reply/{$row['node_id']}" class="btn btn-sm btn-icon btn-rounded btn-primary">
                      <i class="fa fa-pencil-alt"></i>
                    </a>
                  {/if}
