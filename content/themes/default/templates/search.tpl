...
<div class="page-header">
  <img class="floating-img d-none d-md-block" src="{$system['system_url']}/comunidade/content/themes/{$system['theme']}/images/headers/undraw_file_searching_duff.svg">
      ...
      <div class="row">
        ...
        {/if}
          ...
          <ul class="nav nav-pills nav-fill nav-search mb10">
            <li class="nav-item">
              <a class="nav-link rounded-pill {if $tab == "" || $tab == "posts"}active{/if}" href="{$system['system_url']}/comunidade/search/{if $hashtag}hashtag/{/if}{$query}/posts">
                <i class="fa fa-newspaper mr5"></i><strong>{__("Posts")}</strong>
              </a>
            </li>
            {if $system['blogs_enabled']}
              <li class="nav-item">
                <a class="nav-link rounded-pill {if $tab == "articles"}active{/if}" href="{$system['system_url']}/comunidade/search/{if $hashtag}hashtag/{/if}{$query}/articles">
                  <i class="fab fa-blogger-b mr5"></i><strong>{__("Articles")}</strong>
                </a>
              </li>
            {/if}
            <li class="nav-item">
              <a class="nav-link rounded-pill {if $tab == "users"}active{/if}" href="{$system['system_url']}/comunidade/search/{$query}/users">
                <i class="fa fa-user mr5"></i><strong>{__("Users")}</strong>
              </a>
            </li>
            {if $system['pages_enabled']}
              <li class="nav-item">
                <a class="nav-link rounded-pill {if $tab == "pages"}active{/if}" href="{$system['system_url']}/comunidade/search/{$query}/pages">
            ...
            {if $system['groups_enabled']}
              <li class="nav-item">
                <a class="nav-link rounded-pill {if $tab == "groups"}active{/if}" href="{$system['system_url']}/comunidade/search/{$query}/groups">
            ...
            {if $system['events_enabled']}
              <li class="nav-item">
                <a class="nav-link rounded-pill {if $tab == "events"}active{/if}" href="{$system['system_url']}/comunidade/search/{$query}/events">
