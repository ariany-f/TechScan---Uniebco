...
<div class="page-header">
  <img class="floating-img d-none d-md-block" src="{$system['system_url']}/comunidade/content/themes/{$system['theme']}/images/headers/undraw_wallet_aym5.svg">
      ...
      <div class="content-tabs rounded-sm shadow-sm clearfix">
        <ul>
          <li {if $view == ""}class="active" {/if}>
            <a href="{$system['system_url']}/comunidade/wallet"><i class="fa fa-wallet mr5"></i>{__("Wallet")}</a>
          </li>
          {if $system['wallet_withdrawal_enabled']}
            <li {if $view == "payments"}class="active" {/if}>
              <a href="{$system['system_url']}/comunidade/wallet/payments"><i class="fa fa-money-check-alt mr5"></i>{__("Payments")}</a>
            </li>
          {/if}
        </ul>
      </div>
                          ...
                          <tr>
                            ...
                            <td>
                              ...
                              {if $transaction['node_type'] == "user"}
                                <a target="_blank" href="{$system['system_url']}/comunidade/{$transaction['user_name']}">
