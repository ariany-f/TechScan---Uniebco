...
<div class="page-header">
  <img class="floating-img d-none d-md-block" src="{$system['system_url']}/comunidade/content/themes/{$system['theme']}/images/headers/undraw_online_shopping_ga73.svg">
          ...
          <ul class="side-nav">
            ...
            {else}
              <li>
                {if $current_category['parent']}
                  <a href="{$system['system_url']}/comunidade/market/category/{$current_category['parent']['category_id']}/{$current_category['parent']['category_url']}">
            ...
            {foreach $categories as $category}
              <li {if $view == "category" && $current_category['category_id'] == $category['category_id']}class="active" {/if}>
                <a href="{$system['system_url']}/comunidade/market/category/{$category['category_id']}/{$category['category_url']}">
            ...
            <div class="col-md-6 col-lg-4">
              <div class="card product boosted">
                ...
                <div class="product-image">
                  ...
                  {else}
                    <img src="{$system['system_url']}/comunidade/content/themes/{$system['theme']}/images/blank_product.png">
                  {/if}
                  <div class="product-overlay">
                    <a class="btn btn-sm btn-outline-secondary rounded-pill" href="{$system['system_url']}/comunidade/posts/{$post['post_id']}">
                      {__("More")}
                    </a>
                ...
                <div class="product-info">
                  <div class="product-meta title">
                    <a href="{$system['system_url']}/comunidade/posts/{$post['post_id']}" class="title">{$post['product']['name']}</a>
                  </div>
