      ...
      <div class="content-tabs rounded-sm shadow-sm clearfix">
        <ul>
          <li {if $view == ""}class="active" {/if}>
            <a href="{$system['system_url']}/comunidade/events">{__("Discover")}</a>
          </li>
          {if $user->_logged_in}
            <li {if $view == "going"}class="active" {/if}>
              <a href="{$system['system_url']}/comunidade/events/going">{__("Going")}</a>
            </li>
            <li {if $view == "interested"}class="active" {/if}>
              <a href="{$system['system_url']}/comunidade/events/interested">{__("Interested")}</a>
            </li>
            <li {if $view == "invited"}class="active" {/if}>
              <a href="{$system['system_url']}/comunidade/events/invited">{__("Invited")}</a>
            </li>
            <li {if $view == "manage"}class="active" {/if}>
              <a href="{$system['system_url']}/comunidade/events/manage">{__("My Events")}</a>
            </li>
          {/if}
        </ul>
