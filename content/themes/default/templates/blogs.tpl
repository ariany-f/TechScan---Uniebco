...
{if $view == "" && 1 == 0}
  ...
  <div class="page-header">
    <img class="floating-img d-none d-md-block" src="{$system['system_url']}/comunidade/content/themes/{$system['theme']}/images/headers/undraw_content_creator_xeju.svg">
          ...
          <div class="col-md-4">
            ...
            {if $user->_logged_in && $user->_data['can_write_articles']}
              <div class="mb10 d-none d-sm-block">
                <a href="{$system['system_url']}/comunidade/blogs/new" class="btn btn-success btn-block">
            ...
            {if $blogs_categories}
              ...
              <ul class="article-categories clearfix">
                {foreach $blogs_categories as $category}
                  <li>
                    <a class="article-category" href="{$system['system_url']}/comunidade/blogs/category/{$category['category_id']}/{$category['category_url']}">
      ...
      <div class="col-md-8 col-lg-10 offcanvas-mainbar mt10">
        <div class="row">
          ...
          <div class="col-md-8 mb20">
            <div class="article mb20" data-id="{$article['post_id']}">
              <div class="article-wrapper {if $user->_logged_in}pb10{/if}">
                {if $article['manage_post']}
                  <div class="text-right">
                    <a class="btn btn-sm btn-outline-primary rounded-pill ml5 mb5" href="{$system['system_url']}/comunidade/blogs/edit/{$article['post_id']}">
                ...
                <!-- article category -->
                <div class="mb10">
                  <a class="article-category" href="{$system['system_url']}/comunidade/blogs/category/{$article['article']['category_id']}/{$article['article']['category_url']}">
                ...
                <!-- social share -->
                <div class="mb20">
                  <a href="http://www.facebook.com/sharer.php?u={$system['system_url']}/comunidade/blogs/{$article['post_id']}/{$article['article']['title_url']}" class="btn btn-sm btn-rounded btn-social-icon btn-facebook" target="_blank">
                    <i class="fab fa-facebook-f"></i>
                  </a>
                  <a href="https://twitter.com/intent/tweet?url={$system['system_url']}/comunidade/blogs/{$article['post_id']}/{$article['article']['title_url']}" class="btn btn-sm btn-rounded btn-social-icon btn-rounded btn-twitter" target="_blank">
                    <i class="fab fa-twitter"></i>
                  </a>
                  <a href="https://vk.com/share.php?url={$system['system_url']}/comunidade/blogs/{$article['post_id']}/{$article['article']['title_url']}" class="btn btn-sm btn-rounded btn-social-icon btn-vk" target="_blank">
                    <i class="fab fa-vk"></i>
                  </a>
                  <a href="https://www.linkedin.com/shareArticle?mini=true&url={$system['system_url']}/comunidade/blogs/{$article['post_id']}/{$article['article']['title_url']}" class="btn btn-sm btn-rounded btn-social-icon btn-linkedin" target="_blank">
                    <i class="fab fa-linkedin"></i>
                  </a>
                  <a href="https://api.whatsapp.com/send?text={$system['system_url']}/comunidade/blogs/{$article['post_id']}/{$article['article']['title_url']}" class="btn btn-sm btn-rounded btn-social-icon btn-whatsapp d-none d-sm-inline-block" target="_blank">
                    <i class="fab fa-whatsapp"></i>
                  </a>
                  <a href="https://reddit.com/submit?url={$system['system_url']}/comunidade/blogs/{$article['post_id']}/{$article['article']['title_url']}" class="btn btn-sm btn-rounded btn-social-icon btn-reddit" target="_blank">
                    <i class="fab fa-reddit"></i>
                  </a>
                  <a href="https://pinterest.com/pin/create/button/?url={$system['system_url']}/comunidade/blogs/{$article['post_id']}/{$article['article']['title_url']}" class="btn btn-sm btn-rounded btn-social-icon btn-pinterest" target="_blank">
                  ...
                  <div class="article-tags">
                    <ul>
                      {foreach $article['article']['parsed_tags'] as $tag}
                        <li>
                          <a href="{$system['system_url']}/comunidade/search/hashtag/{$tag}">{__($tag)}</a>
                        </li>
                      {/foreach}
                    </ul>
                  </div>
              ...
              <div class="post-footer" id="article-comments">
                ...
                {else}
                  <div class="ptb10">
                    <a href="{$system['system_url']}/comunidade/signin">{__("Please log in to like, share and comment!")}</a>
                  </div>
                {/if}
              </div>
              <!-- post footer -->
          ...
          <div class="col-md-4">
            ...
            {if $user->_logged_in && $user->_data['can_write_articles']}
              <div class="mb10 d-none d-sm-block">
                <a href="{$system['system_url']}/comunidade/blogs/new" class="btn btn-sm btn-success btn-block">
                  <i class="fa fa-edit mr5"></i>{__("Write New Article")}
                </a>
              </div>
            {/if}
        ...
        <div class="card">
          <div class="card-header with-icon">
            ...
            <div class="float-right">
              <a href="{$system['system_url']}/comunidade/blogs/{$article['post_id']}/{$article['article']['title_url']}" class="btn btn-sm btn-light">
