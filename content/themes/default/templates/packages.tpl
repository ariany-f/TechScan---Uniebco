...
{if $view == "packages"}
  ...
  <div class="page-header">
    <img class="floating-img d-none d-md-block" src="{$system['system_url']}/comunidade/content/themes/{$system['theme']}/images/headers/undraw_upgrade_06a0.svg">
                  ...
                  <div class="card card-pricing shadow-sm">
                    ...
                    <div class="card-footer bg-transparent">
                      {if $user->_logged_in}
                        ...
                        {/if}
                      {else}
                        <a class="btn btn-block rounded-pill btn-danger" href="{$system['system_url']}/comunidade/signin">
                          {__("Buy Now")}
                        </a>
                      {/if}
                    </div>
