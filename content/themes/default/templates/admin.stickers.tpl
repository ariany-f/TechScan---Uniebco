  ...
  <div class="card-header with-icon">
    {if $sub_view == ""}
      <div class="float-right">
        <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/stickers/add" class="btn btn-sm btn-primary">
          <i class="fa fa-plus mr5"></i>{__("Add New Sticker")}
        </a>
      </div>
    {else}
      <div class="float-right">
        <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/stickers" class="btn btn-sm btn-light">
          ...
          <tbody>
            {foreach $rows as $row}
              <tr>
                ...
                <td>
                  <a data-toggle="tooltip" data-placement="top" title='{__("Edit")}' href="{$system['system_url']}/comunidade/{$control_panel['url']}/stickers/edit/{$row['sticker_id']}" class="btn btn-sm btn-icon btn-rounded btn-primary">
