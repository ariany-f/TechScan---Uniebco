<div class="card">
  <div class="card-header with-icon">
    {if $sub_view == "find"}
      <div class="float-right">
        <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/events" class="btn btn-sm btn-light">
    ...
    {elseif $sub_view == "edit_event"}
      <div class="float-right">
        ...
        <a target="_blank" href="{$system['system_url']}/comunidade/events/{$data['event_id']}" class="btn btn-sm btn-info">
          <i class="fa fa-tv"></i><span class="ml5 d-none d-lg-inline-block">{__("View Event")}</span>
        </a>
      </div>
    {elseif $sub_view == "categories"}
      <div class="float-right">
        <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/events/add_category" class="btn btn-sm btn-primary">
    ...
    {elseif $sub_view == "add_category" || $sub_view == "edit_category"}
      <div class="float-right">
        <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/events/categories" class="btn btn-sm btn-light">
          <i class="fa fa-arrow-circle-left"></i><span class="ml5 d-none d-lg-inline-block">{__("Go Back")}</span>
        </a>
      </div>
    {/if}
  ...
  {if $sub_view == "" || $sub_view == "find"}
    ...
    <div class="card-body">
      ...
      <!-- search form -->
      <div class="mb20">
        <form class="form-inline" action="{$system['system_url']}/comunidade/{$control_panel['url']}/events/find" method="get">
          ...
          <tbody>
            {if $rows}
              {foreach $rows as $row}
                <tr>
                  <td>
                    <a href="{$system['system_url']}/comunidade/events/{$row['event_id']}" target="_blank">{$row['event_id']}</a>
                  </td>
                  <td>
                    <a target="_blank" href="{$system['system_url']}/comunidade/events/{$row['event_id']}">
                      {$row['event_title']}
                    </a>
                  </td>
                  <td>
                  ...
                  <td>
                    <a data-toggle="tooltip" data-placement="top" title='{__("Edit")}' href="{$system['system_url']}/comunidade/{$control_panel['url']}/events/edit_event/{$row['event_id']}" class="btn btn-sm btn-icon btn-rounded btn-primary">
  ...
  {elseif $sub_view == "edit_event"}
    ...
    <form class="js_ajax-forms" data-url="admin/events.php?do=edit_event&id={$data['event_id']}">
      ...
      <div class="card-footer text-right">
        ...
        <button type="button" class="btn btn-danger js_admin-deleter" data-handle="event" data-id="{$data['event_id']}" data-redirect="{$system['system_url']}/comunidade/{$control_panel['url']}/events">
