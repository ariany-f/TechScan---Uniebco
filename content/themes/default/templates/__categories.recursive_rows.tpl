<tr class="treegrid-{$row['category_id']} {if $row['category_parent_id'] != '0'}treegrid-parent-{$row['category_parent_id']}{/if}">
  ...
  <td>
    <a data-toggle="tooltip" data-placement="top" title='{__("Edit")}' href="{$system['system_url']}/comunidade/{$control_panel['url']}/{$_url}/edit_category/{$row['category_id']}" class="btn btn-sm btn-icon btn-rounded btn-primary">
