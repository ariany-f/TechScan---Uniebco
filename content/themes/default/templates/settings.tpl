...
<div class="container offcanvas">
  <div class="row">
    ...
    <!-- left panel -->
    <div class="col-md-3 col-lg-3 offcanvas-sidebar">
      <div class="card">
        <div class="card-body with-nav">
          <ul class="side-nav">
            <li {if $view == ""}class="active" {/if}>
              <a href="{$system['system_url']}/comunidade/settings">
              ...
              <div class='collapse {if $view == "profile"}show{/if}' id="info-settings">
                <ul>
                  <li {if $view == "profile" && $sub_view == ""}class="active" {/if}>
                    <a href="{$system['system_url']}/comunidade/settings/profile">
                      {__("Basic")}
                    </a>
                  </li>
                  {if $system['work_info_enabled']}
                    <li {if $view == "profile" && $sub_view == "work"}class="active" {/if}>
                      <a href="{$system['system_url']}/comunidade/settings/profile/work">
                        {__("Work")}
                      </a>
                    </li>
                  {/if}
                  {if $system['location_info_enabled']}
                    <li {if $view == "profile" && $sub_view == "location"}class="active" {/if}>
                      <a href="{$system['system_url']}/comunidade/settings/profile/location">
                        {__("Location")}
                      </a>
                    </li>
                  {/if}
                  {if $system['education_info_enabled']}
                    <li {if $view == "profile" && $sub_view == "education"}class="active" {/if}>
                      <a href="{$system['system_url']}/comunidade/settings/profile/education">
                        {__("Education")}
                      </a>
                    </li>
                  {/if}
                  {if $custom_fields['other']}
                    <li {if $view == "profile" && $sub_view == "other"}class="active" {/if}>
                      <a href="{$system['system_url']}/comunidade/settings/profile/other">
                        {__("Other")}
                      </a>
                    </li>
                  {/if}
                  {if $system['social_info_enabled']}
                    <li {if $view == "profile" && $sub_view == "social"}class="active" {/if}>
                      <a href="{$system['system_url']}/comunidade/settings/profile/social">
                        {__("Social Links")}
                      </a>
                    </li>
                  {/if}
                  {if $system['system_profile_background_enabled']}
                    <li {if $view == "profile" && $sub_view == "design"}class="active" {/if}>
                      <a href="{$system['system_url']}/comunidade/settings/profile/design">
                        {__("Design")}
                      </a>
                    </li>
                  {/if}
              ...
              <div class='collapse {if $view == "security"}show{/if}' id="security-settings">
                <ul>
                  <li {if $view == "security" && $sub_view == "password"}class="active" {/if}>
                    <a href="{$system['system_url']}/comunidade/settings/security/password">
                      {__("Password")}
                    </a>
                  </li>
                  <li {if $view == "security" && $sub_view == "sessions"}class="active" {/if}>
                    <a href="{$system['system_url']}/comunidade/settings/security/sessions">
                      {__("Manage Sessions")}
                    </a>
                  </li>
                  {if $system['two_factor_enabled']}
                    <li {if $view == "security" && $sub_view == "two-factor"}class="active" {/if}>
                      <a href="{$system['system_url']}/comunidade/settings/security/two-factor">
            ...
            <li {if $view == "privacy"}class="active" {/if}>
              <a href="{$system['system_url']}/comunidade/settings/privacy">
                <i class="fa fa-user-secret fa-fw mr10" style="color: #ffb307;"></i>{__("Privacy")}
              </a>
            </li>

            <li {if $view == "notifications"}class="active" {/if}>
              <a href="{$system['system_url']}/comunidade/settings/notifications">
            ...
            {if $system['social_login_enabled']}
              {if $system['facebook_login_enabled'] || $system['google_login_enabled'] || $system['twitter_login_enabled'] || $system['linkedin_login_enabled'] || $system['vkontakte_login_enabled']}
                <li {if $view == "linked"}class="active" {/if}>
                  <a href="{$system['system_url']}/comunidade/settings/linked">
            ...
            {if $system['packages_enabled']}
              <li {if $view == "membership"}class="active" {/if}>
                <a href="{$system['system_url']}/comunidade/settings/membership">
            ...
            {if $user->_data['can_invite_users']}
              <li {if $view == "invitations"}class="active" {/if}>
                <a href="{$system['system_url']}/comunidade/settings/invitations">
                ...
                <div class='collapse {if $view == "affiliates"}show{/if}' id="affiliates-settings">
                  <ul>
                    <li {if $view == "affiliates" && $sub_view == ""}class="active" {/if}>
                      <a href="{$system['system_url']}/comunidade/settings/affiliates">
                        {__("My Affiliates")}
                      </a>
                    </li>
                    {if $system['affiliates_money_withdraw_enabled']}
                      <li {if $view == "affiliates" && $sub_view == "payments"}class="active" {/if}>
                        <a href="{$system['system_url']}/comunidade/settings/affiliates/payments">
                          {__("Payments")}
                        </a>
                      </li>
                    {/if}
                ...
                <div class='collapse {if $view == "points"}show{/if}' id="points-settings">
                  <ul>
                    <li {if $view == "points" && $sub_view == ""}class="active" {/if}>
                      <a href="{$system['system_url']}/comunidade/settings/points">
                        {__("My Points")}
                      </a>
                    </li>
                    {if $system['points_money_withdraw_enabled']}
                      <li {if $view == "points" && $sub_view == "payments"}class="active" {/if}>
                        <a href="{$system['system_url']}/comunidade/settings/points/payments">
                          {__("Payments")}
                        </a>
                      </li>
                    {/if}
            ...
            {if $user->_data['can_raise_funding']}
              <li {if $view == "funding"}class="active" {/if}>
                <a href="{$system['system_url']}/comunidade/settings/funding">
            ...
            {if $system['coinpayments_enabled']}
              <li {if $view == "coinpayments"}class="active" {/if}>
                <a href="{$system['system_url']}/comunidade/settings/coinpayments">
            ...
            {if $system['bank_transfers_enabled']}
              <li {if $view == "bank"}class="active" {/if}>
                <a href="{$system['system_url']}/comunidade/settings/bank">
            ...
            {if $system['verification_requests']}
              <li {if $view == "verification"}class="active" {/if}>
                <a href="{$system['system_url']}/comunidade/settings/verification">
            ...
            {if $system['developers_apps_enabled']}
              <li {if $view == "apps"}class="active" {/if}>
                <a href="{$system['system_url']}/comunidade/settings/apps">
            ...
            <li {if $view == "blocking"}class="active" {/if}>
              <a href="{$system['system_url']}/comunidade/settings/blocking">
            ...
            {if $system['download_info_enabled']}
              <li {if $view == "information"}class="active" {/if}>
                <a href="{$system['system_url']}/comunidade/settings/information">
            ...
            {if $system['delete_accounts_enabled']}
              <li {if $view == "delete"}class="active" {/if}>
                <a href="{$system['system_url']}/comunidade/settings/delete">
              ...
              <div class="pl-md-4">
                <div class="form-group form-row">
                  ...
                  <div class="col-md-9">
                    <div class="input-group">
                      <div class="input-group-prepend">
                        <span class="input-group-text d-none d-sm-block">{$system['system_url']}/comunidade/</span>
                      </div>
          ...
          {if $sub_view == ""}
            <div class="card-header with-icon">
              ...
              <div class="float-right">
                <a target="_blank" href="{$system['system_url']}/comunidade/{$user->_data['user_name']}" class="btn btn-sm btn-info">
          ...
          <div class="card-body">
            {if $system['facebook_login_enabled']}
              <div class="form-table-row">
                ...
                <div class="text-right">
                  {if $user->_data['facebook_connected']}
                    <a class="btn btn-sm btn-danger" href="{$system['system_url']}/comunidade/revoke/facebook">{__("Disconnect")}</a>
                  {else}
                    <a class="btn btn-sm btn-primary" href="{$system['system_url']}/comunidade/connect/facebook">{__("Connect")}</a>
                  {/if}
                </div>
              </div>
            {/if}
            ...
            {if $system['google_login_enabled']}
              <div class="form-table-row">
                ...
                <div class="text-right">
                  {if $user->_data['google_connected']}
                    <a class="btn btn-sm btn-danger" href="{$system['system_url']}/comunidade/revoke/google">{__("Disconnect")}</a>
                  {else}
                    <a class="btn btn-sm btn-primary" href="{$system['system_url']}/comunidade/connect/google">{__("Connect")}</a>
                  {/if}
                </div>
              </div>
            {/if}
            ...
            {if $system['twitter_login_enabled']}
              <div class="form-table-row">
                ...
                <div class="text-right">
                  {if $user->_data['twitter_connected']}
                    <a class="btn btn-sm btn-danger" href="{$system['system_url']}/comunidade/revoke/twitter">{__("Disconnect")}</a>
                  {else}
                    <a class="btn btn-sm btn-primary" href="{$system['system_url']}/comunidade/connect/twitter">{__("Connect")}</a>
                  {/if}
                </div>
              </div>
            {/if}
            ...
            {if $system['linkedin_login_enabled']}
              <div class="form-table-row">
                ...
                <div class="text-right">
                  {if $user->_data['linkedin_connected']}
                    <a class="btn btn-sm btn-danger" href="{$system['system_url']}/comunidade/revoke/linkedin">{__("Disconnect")}</a>
                  {else}
                    <a class="btn btn-sm btn-primary" href="{$system['system_url']}/comunidade/connect/linkedin">{__("Connect")}</a>
                  {/if}
                </div>
              </div>
            {/if}
            ...
            {if $system['vkontakte_login_enabled']}
              <div class="form-table-row">
                ...
                <div class="text-right">
                  {if $user->_data['vkontakte_connected']}
                    <a class="btn btn-sm btn-danger" href="{$system['system_url']}/comunidade/revoke/vkontakte">{__("Disconnect")}</a>
                  {else}
                    <a class="btn btn-sm btn-primary" href="{$system['system_url']}/comunidade/connect/vkontakte">{__("Connect")}</a>
                  {/if}
                </div>
              </div>
            {/if}
          ...
          <div class="card-body">
            <div class="alert alert-primary">
              ...
              <div class="text">
                ...
                {__("Choose the Plan That's Right for You")}, {__("Check the package from")} <a class="alert-link" href="{$system['system_url']}/comunidade/packages">{__("Here")}</a>
              </div>
            </div>
              ...
              {if $user->_data['user_subscribed']}
                ...
                <div class="pl-md-4">
                  ...
                  <div class="form-group form-row">
                    ...
                    <div class="col-md-9">
                      <p class="form-control-plaintext">
                        {$user->_data['user_boosted_posts']}/{$user->_data['boost_posts']} (<a href="{$system['system_url']}/comunidade/boosted/posts">{__("Manage")}</a>)
                      </p>
                  ...
                  <div class="form-group form-row">
                    ...
                    <div class="col-md-9">
                      <p class="form-control-plaintext">
                        {$user->_data['user_boosted_pages']}/{$user->_data['boost_pages']} (<a href="{$system['system_url']}/comunidade/boosted/pages">{__("Manage")}</a>)
                      </p>
                ...
                <div class="pl-md-4">
                  <div class="text-center">
                    <a href="{$system['system_url']}/comunidade/packages" class="btn btn-md btn-success"><i class="fa fa-rocket mr10"></i>{__("Upgrade Package")}</a>
                  </div>
                </div>
              {else}
                <div class="text-center">
                  <a href="{$system['system_url']}/comunidade/packages" class="btn btn-md btn-success"><i class="fa fa-rocket mr10"></i>{__("Upgrade to Pro")}</a>
                </div>
              {/if}
            </form>
          </div>
                  ...
                  <tbody>
                    {foreach $invitation_codes as $invitation_code}
                      <tr>
                        ...
                        <td>
                          {if $invitation_code['used']}
                            <a target="_blank" href="{$system['system_url']}/comunidade/{$invitation_code['user_name']}">
          ...
          <div class="card-body">
            {if $sub_view == ""}
              <div class="alert alert-primary">
                ...
                <div class="text">
                  ...
                  {if $system['affiliates_money_transfer_enabled']}
                    ...
                    {__("You can transfer your money to your")} <a class="alert-link" href="{$system['system_url']}/comunidade/wallet" target="_blank"><i class="fa fa-wallet"></i> {__("wallet")}</a>
                  {/if}
                </div>
              </div>
              ...
              <div style="margin: 25px auto; width: 60%;">
                <div class="input-group">
                  <input type="text" disabled class="form-control" value="{$system['system_url']}/comunidade/?ref={$user->_data['user_name']}">
                  <div class="input-group-append">
                    <button class="btn btn-light js_clipboard" data-clipboard-text="{$system['system_url']}/comunidade/?ref={$user->_data['user_name']}" data-toggle="tooltip" data-placement="top" title='{__("Copy")}'>
              ...
              <div class="text-center text-xlg mb20">
                {__("Share")}<br>
                <a href="http://www.facebook.com/sharer.php?u={$system['system_url']}/comunidade/?ref={$user->_data['user_name']}" class="btn btn-sm btn-rounded btn-social-icon btn-facebook" target="_blank">
                  <i class="fab fa-facebook-f"></i>
                </a>
                <a href="https://twitter.com/intent/tweet?url={$system['system_url']}/comunidade/?ref={$user->_data['user_name']}" class="btn btn-sm btn-rounded btn-social-icon btn-rounded btn-twitter" target="_blank">
                  <i class="fab fa-twitter"></i>
                </a>
                <a href="https://vk.com/share.php?url={$system['system_url']}/comunidade/?ref={$user->_data['user_name']}" class="btn btn-sm btn-rounded btn-social-icon btn-vk" target="_blank">
                  <i class="fab fa-vk"></i>
                </a>
                <a href="https://www.linkedin.com/shareArticle?mini=true&url={$system['system_url']}/comunidade/?ref%3D{$user->_data['user_name']}" class="btn btn-sm btn-rounded btn-social-icon btn-linkedin" target="_blank">
                  <i class="fab fa-linkedin"></i>
                </a>
                <a href="https://api.whatsapp.com/send?text={$system['system_url']}/comunidade/?ref%3D{$user->_data['user_name']}" class="btn btn-sm btn-rounded btn-social-icon btn-whatsapp d-none d-sm-inline-block" target="_blank">
                  <i class="fab fa-whatsapp"></i>
                </a>
                <a href="https://reddit.com/submit?url={$system['system_url']}/comunidade/?ref={$user->_data['user_name']}" class="btn btn-sm btn-rounded btn-social-icon btn-reddit" target="_blank">
                  <i class="fab fa-reddit"></i>
                </a>
                <a href="https://pinterest.com/pin/create/button/?url={$system['system_url']}/comunidade/?ref={$user->_data['user_name']}" class="btn btn-sm btn-rounded btn-social-icon btn-pinterest" target="_blank">
