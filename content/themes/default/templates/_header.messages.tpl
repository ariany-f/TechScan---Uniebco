<li class="dropdown js_live-messages">
  ...
  <div class="dropdown-menu dropdown-menu-right dropdown-widget">
    <div class="dropdown-widget-header">
      ...
      <a class="float-right text-link js_chat-new" href="{$system['system_url']}/comunidade/messages/new">{__("Send a New Message")}</a>
    </div>
    ...
    <a class="dropdown-widget-footer" href="{$system['system_url']}/comunidade/messages">{__("See All")}</a>
  </div>
</li>