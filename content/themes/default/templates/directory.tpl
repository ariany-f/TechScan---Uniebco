...
<div class="page-header">
  <img class="floating-img d-none d-md-block" src="{$system['system_url']}/comunidade/content/themes/{$system['theme']}/images/headers/undraw_bookmarks_r6up.svg">
          ...
          <div class="card-body page-content pb25">
            <div class="row">
              <div class="col-sm-6 col-md-6 col-lg-4 mb25">
                <a href="{$system['system_url']}/comunidade/directory/users" class="directory-card">
              ...
              <div class="col-sm-6 col-md-6 col-lg-4 mb25">
                <a href="{$system['system_url']}/comunidade/directory/posts" class="directory-card">
              ...
              {if $system['pages_enabled']}
                <div class="col-sm-6 col-md-6 col-lg-4 mb25">
                  <a href="{$system['system_url']}/comunidade/directory/pages" class="directory-card">
              ...
              {if $system['groups_enabled']}
                <div class="col-sm-6 col-md-6 col-lg-4 mb25">
                  <a href="{$system['system_url']}/comunidade/directory/groups" class="directory-card">
              ...
              {if $system['events_enabled']}
                <div class="col-sm-6 col-md-6 col-lg-4 mb25">
                  <a href="{$system['system_url']}/comunidade/directory/events" class="directory-card">
              ...
              {if $system['blogs_enabled']}
                <div class="col-sm-6 col-md-6 col-lg-4 mb25">
                  <a href="{$system['system_url']}/comunidade/blogs" class="directory-card">
              ...
              {if $system['market_enabled']}
                <div class="col-sm-6 col-md-6 col-lg-4 mb25">
                  <a href="{$system['system_url']}/comunidade/market" class="directory-card">
              ...
              {if $system['funding_enabled']}
                <div class="col-sm-6 col-md-6 col-lg-4 mb25">
                  <a href="{$system['system_url']}/comunidade/funding" class="directory-card">
              ...
              {if $system['pages_enabled'] && $system['offers_enabled']}
                <div class="col-sm-6 col-md-6 col-lg-4 mb25">
                  <a href="{$system['system_url']}/comunidade/offers" class="directory-card">
              ...
              {if $system['pages_enabled'] && $system['jobs_enabled']}
                <div class="col-sm-6 col-md-6 col-lg-4 mb25">
                  <a href="{$system['system_url']}/comunidade/jobs" class="directory-card">
              ...
              {if $system['forums_enabled']}
                <div class="col-sm-6 col-md-6 col-lg-4 mb25">
                  <a href="{$system['system_url']}/comunidade/forums" class="directory-card">
              ...
              {if $system['movies_enabled']}
                <div class="col-sm-6 col-md-6 col-lg-4 mb25">
                  <a href="{$system['system_url']}/comunidade/movies" class="directory-card">
              ...
              {if $system['games_enabled']}
                <div class="col-sm-6 col-md-6 col-lg-4 mb25">
                  <a href="{$system['system_url']}/comunidade/directory/games" class="directory-card">
            ...
            <ul class="side-nav">
              ...
              {if $system['groups_enabled']}
                <li {if $view == "groups"}class="active" {/if}>
                  <a href="{$system['system_url']}/comunidade/directory/groups">
              ...
              {if $system['events_enabled']}
                <li {if $view == "events"}class="active" {/if}>
                  <a href="{$system['system_url']}/comunidade/directory/events">
              ...
              {if $system['games_enabled']}
                <li {if $view == "games"}class="active" {/if}>
                  <a href="{$system['system_url']}/comunidade/directory/games">
