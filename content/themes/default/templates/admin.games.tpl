  ...
  <div class="card-header with-icon">
    {if $sub_view == ""}
      <div class="float-right">
        <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/games/add" class="btn btn-sm btn-primary">
          <i class="fa fa-plus mr5"></i>{__("Add New game")}
        </a>
      </div>
    {elseif $sub_view == "add" || $sub_view == "edit"}
      <div class="float-right">
        <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/games" class="btn btn-sm btn-light">
          ...
          <tbody>
            {foreach $rows as $row}
              <tr>
                <td>{$row['game_id']}</td>
                <td>
                  <a target="_blank" href="{$system['system_url']}/comunidade/games/{$row['game_id']}/{$row['title_url']}">
                    <img class="tbl-image" src="{$row['thumbnail']}">
                    {$row['title']}
                  </a>
                </td>
                <td>
                  <a data-toggle="tooltip" data-placement="top" title='{__("Edit")}' href="{$system['system_url']}/comunidade/{$control_panel['url']}/games/edit/{$row['game_id']}" class="btn btn-sm btn-icon btn-rounded btn-primary">
