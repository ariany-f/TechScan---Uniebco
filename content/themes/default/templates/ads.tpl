...
<div class="page-header">
  <img class="floating-img d-none d-md-block" src="{$system['system_url']}/comunidade/content/themes/{$system['theme']}/images/headers/undraw_growth_analytics_8btt.svg">
  ...
  <div class="row">
    ...
    <div class="col-12 offcanvas-mainbar">
      ...
      <div class="content-tabs rounded-sm shadow-sm clearfix">
        <ul>
          <li class="active">
            <a href="{$system['system_url']}/comunidade/ads"><i class="fa fa-chart-line mr5"></i>{__("Ads Campaigns")}</a>
          </li>
        </ul>
      </div>
      <!-- tabs -->
      ...
      {if $view == ""}
        ...
        <div class="card mt20">
          <div class="card-header with-icon">
            <a class="btn btn-sm btn-primary float-right" href="{$system['system_url']}/comunidade/ads/new">
                  ...
                  <tbody>
                    {foreach $campaigns as $campaign}
                      <tr>
                        ...
                        <td>
                          <a data-toggle="tooltip" data-placement="top" title='{__("Edit")}' href="{$system['system_url']}/comunidade/ads/edit/{$campaign['campaign_id']}" class="btn btn-sm btn-icon btn-rounded btn-primary">
        ...
        <div class="card mt20">
          <div class="card-header with-icon">
            ...
            <div class="float-right">
              <a href="{$system['system_url']}/comunidade/ads" class="btn btn-sm btn-light">
            ...
            <div class="card-body">
              {if $user->_data['user_wallet_balance'] == 0}
                <div class="bs-callout bs-callout-danger mt0">
                  {__("Your current wallet credit is")}: <strong>{print_money($user->_data['user_wallet_balance']|number_format:2)}</strong> {__("You need to")} <a href="{$system['system_url']}/comunidade/wallet">{__("Replenish your wallet credit")}</a>
                </div>
              {/if}
