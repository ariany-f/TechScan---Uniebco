<div class="card">
  <div class="card-header with-icon">
    {if $sub_view == ""}
      <div class="float-right">
        <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/forums/add_forum" class="btn btn-sm btn-primary">
          <i class="fa fa-plus mr5"></i>{__("Add New Forum")}
        </a>
      </div>
    {elseif $sub_view == "add_forum" || $sub_view == "edit_forum"}
      <div class="float-right">
        <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/forums" class="btn btn-sm btn-light">
          <i class="fa fa-arrow-circle-left mr5"></i>{__("Go Back")}
        </a>
      </div>
    {elseif $sub_view == "find_threads"}
      <div class="float-right">
        <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/forums/threads" class="btn btn-sm btn-light">
          <i class="fa fa-arrow-circle-left mr5"></i>{__("Go Back")}
        </a>
      </div>
    {elseif $sub_view == "find_replies"}
      <div class="float-right">
        <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/forums/replies" class="btn btn-sm btn-light">
          <i class="fa fa-arrow-circle-left mr5"></i>{__("Go Back")}
        </a>
      </div>
    {/if}
  ...
  {elseif $sub_view == "threads" || $sub_view == "find_threads"}
    ...
    <div class="card-body">
      ...
      <!-- search form -->
      <div class="mb20">
        <form class="form-inline" action="{$system['system_url']}/comunidade/{$control_panel['url']}/forums/find_threads" method="get">
            ...
            {if $rows}
              {foreach $rows as $row}
                <tr>
                  ...
                  <td>
                    <a class="btn btn-sm btn-light" href="{$system['system_url']}/comunidade/forums/thread/{$row['thread_id']}/{$row['thread_title_url']}" target="_blank">
  ...
  {elseif $sub_view == "replies" || $sub_view == "find_replies"}
    ...
    <div class="card-body">
      ...
      <!-- search form -->
      <div class="mb20">
        <form class="form-inline" action="{$system['system_url']}/comunidade/{$control_panel['url']}/forums/find_replies" method="get">
          <div class="form-group mb0">
            <div class="input-group">
              <input type="text" class="form-control" name="query">
              <div class="input-group-append">
            ...
            {if $rows}
              {foreach $rows as $row}
                <tr>
                  ...
                  <td><span class="js_moment" data-time="{$row['time']}">{$row['time']}</span></td>
                  <td>
                    <a class="btn btn-sm btn-light" href="{$system['system_url']}/comunidade/forums/thread/{$row['thread_id']}/{$row['thread_title_url']}/#reply-{$row['reply_id']}" target="_blank">
                      <i class="fa fa-eye mr5"></i>{__("View")}
                    </a>
                  </td>
                  <td>
