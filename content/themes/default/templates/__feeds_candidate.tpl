<div class="job-candidate-wrapper">
  <div class="job-candidate-header">
    <div class="job-candidate-avatar">
      <a class="post-avatar-picture large" href="{$system['system_url']}/comunidade/{$candidate['user_name']}" style="background-image:url({$candidate['user_picture']});"></a>
    </div>
    <div class="job-candidate-info">
      <div class="name">
        <a href="{$system['system_url']}/comunidade/{$candidate['user_name']}">{$candidate['name']}</a>
      </div>
      <div class="row mb10">
        <div class="col-md-6">
