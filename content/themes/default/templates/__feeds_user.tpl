    ...
    <div class="ui-box">
      ...
      <div class="mt10">
        <span class="js_user-popover" data-uid="{$_user['user_id']}">
          <a class="h6" href="{$system['system_url']}/comunidade/{$_user['user_name']}">
...
{elseif $_tpl == "list"}
  <li class="feeds-item" {if $_user['id']}data-id="{$_user['id']}" {/if}>
    <div class="data-container {if $_small}small{/if}">
      <a class="data-avatar" href="{$system['system_url']}/comunidade/{$_user['user_name']}{if $_search}?ref=qs{/if}">
      ...
      <div class="data-content">
        ...
        <div class="mt5">
          <span class="name js_user-popover" data-uid="{$_user['user_id']}">
            <a href="{$system['system_url']}/comunidade/{$_user['user_name']}{if $_search}?ref=qs{/if}">
              {if $system['show_usernames_enabled']}
                {$_user['user_name']}
              {else}
                {$_user['user_firstname']} {$_user['user_lastname']}
