  ...
  <div class="card-header with-icon">
    {if $sub_view == ""}
      <div class="float-right">
        <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/static/add" class="btn btn-sm btn-primary">
          <i class="fa fa-plus mr5"></i>{__("Add New Page")}
        </a>
      </div>
    {else}
      <div class="float-right">
        <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/static" class="btn btn-sm btn-light">
          ...
          <tbody>
            {foreach $rows as $row}
              <tr>
                <td>{$row['page_id']}</td>
                <td>
                  <a target="_blank" href="{$system['system_url']}/comunidade/static/{$row['page_url']}">
                    {$row['page_url']}
                  </a>
                </td>
                ...
                <td>
                  <a data-toggle="tooltip" data-placement="top" title='{__("Edit")}' href="{$system['system_url']}/comunidade/{$control_panel['url']}/static/edit/{$row['page_id']}" class="btn btn-sm btn-icon btn-rounded btn-primary">
          ...
          <div class="col-md-9">
            <div class="input-group">
              <div class="input-group-prepend">
                <span class="input-group-text d-none d-sm-block">{$system['system_url']}/comunidade/static/</span>
              </div>
