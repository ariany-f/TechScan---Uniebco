        ...
        <div class="card-body with-nav">
          <ul class="side-nav">
            ...
            <li {if $view == "dashboard"}class="active" {/if}>
              <a href="{$system['system_url']}/comunidade/{$control_panel['url']}">
                <i class="fa fa-tachometer-alt fa-fw mr10" style="color: #007bff"></i>{__("Dashboard")}
              </a>
            </li>
            <!-- Dashboard -->
            ...
            {if $user->_is_admin}
              ...
              <li {if $view == "themes"}class="active" {/if}>
                <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/themes">
                  <i class="fa fa-desktop fa-fw mr10" style="color: #007bff"></i>{__("Themes")}
                </a>
              </li>
              <!-- Themes -->
              ...
              <li {if $view == "design"}class="active" {/if}>
                <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/design">
                  <i class="fa fa-paint-brush fa-fw mr10" style="color: #007bff"></i>{__("Design")}
                </a>
              </li>
              <!-- Design -->
              ...
              <li {if $view == "languages"}class="active" {/if}>
                <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/languages">
                  <i class="fa fa-language fa-fw mr10" style="color: #007bff"></i>{__("Languages")}
                </a>
              </li>
              <!-- Languages -->
              ...
              <li {if $view == "countries"}class="active" {/if}>
                <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/countries">
                  <i class="fa fa-globe fa-fw mr10" style="color: #007bff"></i>{__("Countries")}
                </a>
              </li>
              <!-- Countries -->
              ...
              <li {if $view == "currencies"}class="active" {/if}>
                <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/currencies">
                  <i class="fa fa-money-bill-alt fa-fw mr10" style="color: #007bff"></i>{__("Currencies")}
                </a>
              </li>
              <!-- Currencies -->
              ...
              <li {if $view == "genders"}class="active" {/if}>
                <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/genders">
                  <i class="fa fa-venus-mars fa-fw mr10" style="color: #007bff"></i>{__("Genders")}
                </a>
              </li>
              <!-- Genders -->
            {/if}
        ...
        <div class="card-body with-nav">
          <ul class="side-nav">
                ...
                <div class='collapse {if $view == "users"}show{/if}' id="users">
                  <ul>
                    <li {if $view == "users" && $sub_view == ""}class="active" {/if}>
                      <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/users">
                        {__("List Users")}
                      </a>
                    </li>
                    <li {if $view == "users" && $sub_view == "admins"}class="active" {/if}>
                      <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/users/admins">
                        {__("List Admins")}
                      </a>
                    </li>
                    <li {if $view == "users" && $sub_view == "moderators"}class="active" {/if}>
                      <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/users/moderators">
                        {__("List Moderators")}
                      </a>
                    </li>
                    <li {if $view == "users" && $sub_view == "online"}class="active" {/if}>
                      <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/users/online">
                        {__("List Online")}
                      </a>
                    </li>
                    <li {if $view == "users" && $sub_view == "banned"}class="active" {/if}>
                      <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/users/banned">
                        {__("List Banned")}
                      </a>
                    </li>
                  </ul>
            ...
            <li {if $view == "posts"}class="active" {/if}>
              <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/posts">
              ...
              <div class='collapse {if $view == "pages"}show{/if}' id="pages">
                <ul>
                  <li {if $view == "pages" && $sub_view == ""}class="active" {/if}>
                    <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/pages">
                      {__("List Pages")}
                    </a>
                  </li>
                  <li {if $view == "pages" && $sub_view == "categories"}class="active" {/if}>
                    <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/pages/categories">
                      {__("List Categories")}
                    </a>
                  </li>
                </ul>
              ...
              <div class='collapse {if $view == "groups"}show{/if}' id="groups">
                <ul>
                  <li {if $view == "groups" && $sub_view == ""}class="active" {/if}>
                    <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/groups">
                      {__("List Groups")}
                    </a>
                  </li>
                  <li {if $view == "groups" && $sub_view == "categories"}class="active" {/if}>
                    <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/groups/categories">
                      {__("List Categories")}
                    </a>
                  </li>
                </ul>
              ...
              <div class='collapse {if $view == "events"}show{/if}' id="events">
                <ul>
                  <li {if $view == "events" && $sub_view == ""}class="active" {/if}>
                    <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/events">
                      {__("List Events")}
                    </a>
                  </li>
                  <li {if $view == "events" && $sub_view == "categories"}class="active" {/if}>
                    <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/events/categories">
                      {__("List Categories")}
                    </a>
                  </li>
                </ul>
              ...
              <div class='collapse {if $view == "blogs"}show{/if}' id="blogs">
                <ul>
                  <li {if $view == "blogs" && $sub_view == ""}class="active" {/if}>
                    <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/blogs">
                      {__("List Articles")}
                    </a>
                  </li>
                  <li {if $view == "blogs" && $sub_view == "categories"}class="active" {/if}>
                    <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/blogs/categories">
                      {__("List Categories")}
                    </a>
                  </li>
                </ul>
              ...
              <div class='collapse {if $view == "market"}show{/if}' id="market">
                <ul>
                  <li {if $view == "market" && $sub_view == "categories"}class="active" {/if}>
                    <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/market/categories">
                      {__("List Categories")}
                    </a>
                  </li>
                </ul>
              ...
              <div class='collapse {if $view == "offers"}show{/if}' id="offers">
                <ul>
                  <li {if $view == "offers" && $sub_view == ""}class="active" {/if}>
                    <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/offers">
                      {__("List Offers")}
                    </a>
                  </li>
                  <li {if $view == "offers" && $sub_view == "categories"}class="active" {/if}>
                    <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/offers/categories">
                      {__("List Categories")}
                    </a>
                  </li>
                </ul>
              ...
              <div class='collapse {if $view == "jobs"}show{/if}' id="jobs">
                <ul>
                  <li {if $view == "jobs" && $sub_view == ""}class="active" {/if}>
                    <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/jobs">
                      {__("List Jobs")}
                    </a>
                  </li>
                  <li {if $view == "jobs" && $sub_view == "categories"}class="active" {/if}>
                    <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/jobs/categories">
                      {__("List Categories")}
                    </a>
                  </li>
                </ul>
              ...
              <div class='collapse {if $view == "forums"}show{/if}' id="forums">
                <ul>
                  <li {if $view == "forums" && $sub_view == ""}class="active" {/if}>
                    <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/forums">
                      {__("List Forums")}
                    </a>
                  </li>
                  <li {if $view == "forums" && $sub_view == "threads"}class="active" {/if}>
                    <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/forums/threads">
                      {__("List Threads")}
                    </a>
                  </li>
                  <li {if $view == "forums" && $sub_view == "replies"}class="active" {/if}>
                    <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/forums/replies">
                      {__("List Replies")}
                    </a>
                  </li>
                </ul>
              ...
              <div class='collapse {if $view == "movies"}show{/if}' id="movies">
                <ul>
                  <li {if $view == "movies" && $sub_view == ""}class="active" {/if}>
                    <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/movies">
                      {__("List Movies")}
                    </a>
                  </li>
                  <li {if $view == "movies" && $sub_view == "genres"}class="active" {/if}>
                    <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/movies/genres">
                      {__("List Genres")}
                    </a>
                  </li>
                </ul>
            ...
            <li {if $view == "games"}class="active" {/if}>
              <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/games">
                ...
                <div class='collapse {if $view == "ads"}show{/if}' id="ads">
                  <ul>
                    <li {if $view == "ads" && $sub_view == ""}class="active" {/if}>
                      <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/ads">
                        {__("Ads Settings")}
                      </a>
                    </li>
                    <li {if $view == "ads" && $sub_view == "users_ads"}class="active" {/if}>
                      <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/ads/users_ads">
                        {__("List Users Ads")}
                      </a>
                    </li>
                    <li {if $view == "ads" && $sub_view == "system_ads"}class="active" {/if}>
                      <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/ads/system_ads">
                        {__("List System Ads")}
                      </a>
                    </li>
                  </ul>
                ...
                <div class='collapse {if $view == "wallet"}show{/if}' id="wallet">
                  <ul>
                    <li {if $view == "wallet" && $sub_view == ""}class="active" {/if}>
                      <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/wallet">
                        {__("Wallet Settings")}
                      </a>
                    </li>
                    <li {if $view == "wallet" && $sub_view == "payments"}class="active" {/if}>
                      <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/wallet/payments">
                ...
                <div class='collapse {if $view == "pro"}show{/if}' id="pro">
                  <ul>
                    <li {if $view == "pro" && $sub_view == ""}class="active" {/if}>
                      <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/pro">
                        {__("Pro Settings")}
                      </a>
                    </li>
                    <li {if $view == "pro" && $sub_view == "packages"}class="active" {/if}>
                      <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/pro/packages">
                        {__("List Packages")}
                      </a>
                    </li>
                    <li {if $view == "pro" && $sub_view == "subscribers"}class="active" {/if}>
                      <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/pro/subscribers">
                        {__("List Subscribers")}
                      </a>
                    </li>
                    <li {if $view == "pro" && $sub_view == "earnings"}class="active" {/if}>
                      <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/pro/earnings">
                        {__("Earnings")}
                      </a>
                    </li>
                  </ul>
                ...
                <div class='collapse {if $view == "affiliates"}show{/if}' id="affiliates">
                  <ul>
                    <li {if $view == "affiliates" && $sub_view == ""}class="active" {/if}>
                      <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/affiliates">
                        {__("Affiliates Settings")}
                      </a>
                    </li>
                    <li {if $view == "affiliates" && $sub_view == "payments"}class="active" {/if}>
                      <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/affiliates/payments">
                ...
                <div class='collapse {if $view == "points"}show{/if}' id="points">
                  <ul>
                    <li {if $view == "points" && $sub_view == ""}class="active" {/if}>
                      <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/points">
                        {__("Points Settings")}
                      </a>
                    </li>
                    <li {if $view == "points" && $sub_view == "payments"}class="active" {/if}>
                      <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/points/payments">
                ...
                <div class='collapse {if $view == "funding"}show{/if}' id="funding">
                  <ul>
                    <li {if $view == "funding" && $sub_view == ""}class="active" {/if}>
                      <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/funding">
                        {__("Funding Settings")}
                      </a>
                    </li>
                    <li {if $view == "funding" && $sub_view == "payments"}class="active" {/if}>
                      <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/funding/payments">
                    ...
                    <li {if $view == "funding" && $sub_view == "requests"}class="active" {/if}>
                      <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/funding/requests">
                        {__("Funding Requests")}
                      </a>
                    </li>
                  </ul>
          ...
          <div class="card-body with-nav">
            <ul class="side-nav">
              ...
              <li {if $view == "coinpayments"}class="active" {/if}>
                <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/coinpayments">
              ...
              <li {if $view == "bank"}class="active" {/if}>
                <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/bank">
                ...
                <div class='collapse {if $view == "developers"}show{/if}' id="developers">
                  <ul>
                    <li {if $view == "developers" && $sub_view == ""}class="active" {/if}>
                      <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/developers">
                        {__("Developers Settings")}
                      </a>
                    </li>
                    <li {if $view == "developers" && $sub_view == "apps"}class="active" {/if}>
                      <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/developers/apps">
                        {__("List Apps")}
                      </a>
                    </li>
                    <li {if $view == "developers" && $sub_view == "categories"}class="active" {/if}>
                      <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/developers/categories">
                        {__("List Categories")}
                      </a>
                    </li>
                  </ul>
          ...
          <ul class="side-nav">
              ...
              <div class='collapse {if $view == "reports"}show{/if}' id="reports">
                <ul>
                  <li {if $view == "reports" && $sub_view == ""}class="active" {/if}>
                    <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/reports">
                  ...
                  <li {if $view == "reports" && $sub_view == "categories"}class="active" {/if}>
                    <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/reports/categories">
                      {__("List Categories")}
                    </a>
                  </li>
                </ul>
            ...
            {if $user->_is_admin}
              ...
              <li {if $view == "blacklist"}class="active" {/if}>
                <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/blacklist">
              ...
              <div class='collapse {if $view == "verification"}show{/if}' id="verification">
                <ul>
                  <li {if $view == "verification" && $sub_view == ""}class="active" {/if}>
                    <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/verification">
                  ...
                  <li {if $view == "verification" && $sub_view == "users"}class="active" {/if}>
                    <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/verification/users">
                      {__("List Verified Users")}
                    </a>
                  </li>
                  <li {if $view == "verification" && $sub_view == "pages"}class="active" {/if}>
                    <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/verification/pages">
                ...
                <div class='collapse {if $view == "tools"}show{/if}' id="tools">
                  <ul>
                    <li {if $view == "tools" && $sub_view == "faker"}class="active" {/if}>
                      <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/tools/faker">
                        {__("Fake Generator")}
                      </a>
                    </li>
                    <li {if $view == "tools" && $sub_view == "auto-connect"}class="active" {/if}>
                      <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/tools/auto-connect">
                        {__("Auto Connect")}
                      </a>
                    </li>
                    <li {if $view == "tools" && $sub_view == "garbage-collector"}class="active" {/if}>
                      <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/tools/garbage-collector">
                        {__("Garbage Collector")}
                      </a>
                    </li>
                    <li {if $view == "tools" && $sub_view == "backups"}class="active" {/if}>
                      <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/tools/backups">
                        {__("Backup Database & Files")}
                      </a>
                    </li>
                    <li {if $view == "tools" && $sub_view == "reset"}class="active" {/if}>
                      <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/tools/reset">
                        {__("Factory Reset")}
                      </a>
                    </li>
                  </ul>
          ...
          <div class="card-body with-nav">
            <ul class="side-nav">
              ...
              <li {if $view == "custom_fields"}class="active" {/if}>
                <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/custom_fields">
              ...
              <li {if $view == "static"}class="active" {/if}>
                <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/static">
              ...
              <li {if $view == "colored_posts"}class="active" {/if}>
                <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/colored_posts">
              ...
              <li {if $view == "widgets"}class="active" {/if}>
                <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/widgets">
              ...
              <li {if $view == "emojis"}class="active" {/if}>
                <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/emojis">
              ...
              <li {if $view == "stickers"}class="active" {/if}>
                <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/stickers">
              ...
              <li {if $view == "gifts"}class="active" {/if}>
                <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/gifts">
          ...
          <div class="card-body with-nav">
            <ul class="side-nav">
              ...
              <li {if $view == "announcements"}class="active" {/if}>
                <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/announcements">
              ...
              <li {if $view == "notifications"}class="active" {/if}>
                <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/notifications">
              ...
              <li {if $view == "newsletter"}class="active" {/if}>
                <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/newsletter">
          ...
          <div class="card-body with-nav">
            <ul class="side-nav">
              ...
              <li {if $view == "changelog"}class="active" {/if}>
                <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/changelog">
