      ...
      <div class="content-tabs rounded-sm shadow-sm clearfix">
        <ul>
          <li {if $view == "" || $view == "find"}class="active" {/if}>
            <a href="{$system['system_url']}/comunidade/people">{__("Discover")}</a>
          </li>
          <li {if $view == "friend_requests"}class="active" {/if}>
            <a href="{$system['system_url']}/comunidade/people/friend_requests">
              {__("Friend Requests")}
          ...
          <li {if $view == "sent_requests"}class="active" {/if}>
            <a href="{$system['system_url']}/comunidade/people/sent_requests">
              {__("Sent Requests")}
          ...
          <div class="mt10 float-right">
            <button class="btn btn-sm btn-success d-none d-lg-block" data-toggle="modal" data-url="users/add.php">
              <i class="fa fa-plus-circle mr5"></i>{__("Create User")}
            </button>
      ...
      <div class="row">
        ...
        <div class="col-lg-4 order-lg-2">
          ...
          <div class="card">
            ...
            <div class="card-body">
              <form action="{$system['system_url']}/comunidade/people/find" method="post">
