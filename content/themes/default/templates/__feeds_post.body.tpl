...
<div class="post-header">
  ...
  <div class="post-meta">
    ...
    {if !$_shared && $user->_logged_in && $_get != "posts_information"}
      <div class="float-right dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-right post-dropdown-menu">
          ...
          {if $_post['manage_post']}
            ...
            {if $system['packages_enabled'] && !$_post['in_group'] && !$_post['in_event']}
              ...
              {else}
                ...
                {else}
                  <a href="{$system['system_url']}/comunidade/packages" class="dropdown-item">
                    <div class="action no-desc">
                      <i class="fa fa-bolt fa-fw"></i> <span>{__("Boost Post")}</span>
                    </div>
                  </a>
            ...
            {if $_post['post_type'] == "article"}
              <a href="{$system['system_url']}/comunidade/blogs/edit/{$_post['post_id']}" class="dropdown-item pointer">
                <div class="action no-desc">
          ...
          {/if}
          <div class="dropdown-divider"></div>
          <a href="{$system['system_url']}/comunidade/posts/{$_post['post_id']}" target="_blank" class="dropdown-item">
            <div class="action no-desc">
    ...
    <span class="post-title">
      {if !$_shared && $_post['post_type'] == "shared"}
        ...
        {else}
          ...
          <a href="{$system['system_url']}/comunidade/posts/{$_post['origin']['post_id']}">
            ...
            {elseif $_post['origin']['post_type'] == 'file'}
              {if $_post['origin']['files_num'] > 1}{__("files")}{else}{__("file")}{/if}
      ...
      {elseif $_post['post_type'] == "album"}
        {__("added")} {$_post['photos_num']} {__("photos to the album")}: <a href="{$system['system_url']}/comunidade/{$_post['album']['path']}/album/{$_post['album']['album_id']}">{$_post['album']['title']}</a>
      ...
      {if $_get != 'posts_group' && $_post['in_group']}
        <i class="fa fa-caret-right ml5 mr5"></i><i class="fa fa-users ml5 mr5"></i><a href="{$system['system_url']}/comunidade/groups/{$_post['group_name']}">{$_post['group_title']}</a>

      {elseif $_get != 'posts_event' && $_post['in_event']}
        <i class="fa fa-caret-right ml5 mr5"></i><i class="fa fa-calendar ml5 mr5"></i><a href="{$system['system_url']}/comunidade/events/{$_post['event_id']}">{$_post['event_title']}</a>

      {elseif $_post['in_wall']}
        <i class="fa fa-caret-right ml5 mr5"></i>
        <span class="js_user-popover" data-type="user" data-uid="{$_post['wall_id']}">
          <a href="{$system['system_url']}/comunidade/{$_post['wall_username']}">{$_post['wall_fullname']}</a>
        </span>
      {/if}
    </span>
    <!-- post-title -->
    ...
    <div class="post-time">
      <a href="{$system['system_url']}/comunidade/posts/{$_post['post_id']}" class="js_moment" data-time="{$_post['time']}">{$_post['time']}</a>
      {if $_post['location']}
        ...
        <div class="pg_wrapper">
          {if $_post['photos_num'] == 1}
            <div class="pg_1x {if $_post['photos'][0]['blur']}x-blured{/if}">
              <a href="{$system['system_url']}/comunidade/photos/{$_post['photos'][0]['photo_id']}" class="js_lightbox" data-id="{$_post['photos'][0]['photo_id']}" data-image="{$system['system_uploads']}/{$_post['photos'][0]['source']}" data-context="{if $_post['post_type'] == 'product'}post{else}album{/if}">
          ...
          {elseif $_post['photos_num'] == 2}
            {foreach $_post['photos'] as $photo}
              <div class="pg_2x {if $photo['blur']}x-blured{/if}">
                <a href="{$system['system_url']}/comunidade/photos/{$photo['photo_id']}" class="js_lightbox" data-id="{$photo['photo_id']}" data-image="{$system['system_uploads']}/{$photo['source']}" data-context="post" style="background-image:url('{$system['system_uploads']}/{$photo['source']}');"></a>
              </div>
            {/foreach}
            ...
            <div class="pg_3x">
              <div class="pg_2o3">
                <div class="pg_2o3_in {if $_post['photos'][0]['blur']}x-blured{/if}">
                  <a href="{$system['system_url']}/comunidade/photos/{$_post['photos'][0]['photo_id']}" class="js_lightbox" data-id="{$_post['photos'][0]['photo_id']}" data-image="{$system['system_uploads']}/{$_post['photos'][0]['source']}" data-context="post" style="background-image:url('{$system['system_uploads']}/{$_post['photos'][0]['source']}');"></a>
                </div>
              </div>
              <div class="pg_1o3">
                <div class="pg_1o3_in {if $_post['photos'][1]['blur']}x-blured{/if}">
                  <a href="{$system['system_url']}/comunidade/photos/{$_post['photos'][1]['photo_id']}" class="js_lightbox" data-id="{$_post['photos'][1]['photo_id']}" data-image="{$system['system_uploads']}/{$_post['photos'][1]['source']}" data-context="post" style="background-image:url('{$system['system_uploads']}/{$_post['photos'][1]['source']}');"></a>
                </div>
                <div class="pg_1o3_in {if $_post['photos'][2]['blur']}x-blured{/if}">
                  <a href="{$system['system_url']}/comunidade/photos/{$_post['photos'][2]['photo_id']}" class="js_lightbox" data-id="{$_post['photos'][2]['photo_id']}" data-image="{$system['system_uploads']}/{$_post['photos'][2]['source']}" data-context="post" style="background-image:url('{$system['system_uploads']}/{$_post['photos'][2]['source']}');"></a>
                </div>
              </div>
            </div>
          {else}
            <div class="pg_4x">
              ...
              <div class="pg_1o3">
                ...
                <div class="pg_1o3_in {if $_post['photos'][3]['blur']}x-blured{/if}">
                  <a href="{$system['system_url']}/comunidade/photos/{$_post['photos'][3]['photo_id']}" class="js_lightbox" data-id="{$_post['photos'][3]['photo_id']}" data-image="{$system['system_uploads']}/{$_post['photos'][3]['source']}" data-context="post" style="background-image:url('{$system['system_uploads']}/{$_post['photos'][3]['source']}');">
      ...
      <div class="mt10">
        <div class="post-media">
          {if $_post['article']['cover']}
            <a class="post-media-image" href="{$system['system_url']}/comunidade/blogs/{$_post['post_id']}/{$_post['article']['title_url']}">
              <div style="padding-top: 50%; background-size: cover; background-image:url('{$system['system_uploads']}/{$_post['article']['cover']}');"></div>
            </a>
          {/if}
          <div class="post-media-meta">
            <a class="title mb5" href="{$system['system_url']}/comunidade/blogs/{$_post['post_id']}/{$_post['article']['title_url']}">{$_post['article']['title']}</a>
    ...
    {elseif $_post['post_type'] == "funding" && $_post['funding']}
      <div class="mt10">
        <div class="post-media">
          <a class="post-media-image" href="{$system['system_url']}/comunidade/posts/{$_post['post_id']}" target="_blank">
        ...
        <div class="post-funding-meta">
          <div class="funding-title mb10 mt20">
            <a href="{$system['system_url']}/comunidade/posts/{$_post['post_id']}" target="_blank">{$_post['funding']['title']}</a>
          </div>
    ...
    {elseif $_post['post_type'] == "offer" && $_post['offer']}
      <div class="mt10">
        <div class="post-media">
          ...
          <div class="post-media-meta">
            <a class="title mb5 mt20" href="{$system['system_url']}/comunidade/posts/{$_post['post_id']}" target="_blank">{$_post['offer']['meta_title']}</a>
            <!-- post text -->
            {if !$_shared}
              {include file='__feeds_post.text.tpl'}
            {else}
      ...
      <div class="mt10">
        ...
        <div class="post-job-meta">
          <div class="job-title mb10 mt20">
            <a href="{$system['system_url']}/comunidade/posts/{$_post['post_id']}" target="_blank">{$_post['job']['title']}</a>
          </div>
    ...
    {elseif $_post['post_type'] == "file" && $_post['file']}
      {foreach $_post['file'] as $file}
          <div class="post-downloader">
            ...
            <div class="info">
              <strong>{__("File Type")}</strong>: {get_extension({$file['source']})}
              <div class="mt10">
                <a class="btn btn-primary btn-sm" href="{$system['system_uploads']}/{$file['source']}">{__("Download")}</a>
              </div>
            </div>
          </div>
        {/foreach}
