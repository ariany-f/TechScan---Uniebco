  ...
  <div class="card-header with-icon">
    {if $sub_view == "categories"}
      <div class="float-right">
        <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/developers/add_category" class="btn btn-sm btn-primary">
          <i class="fa fa-plus mr5"></i>{__("Add New Category")}
        </a>
      </div>
    {elseif $sub_view == "add_category" || $sub_view == "edit_category"}
      <div class="float-right">
        <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/developers/categories" class="btn btn-sm btn-light">
          ...
          <tbody>
            {foreach $rows as $row}
              <tr>
                <td>{$row['app_id']}</td>
                <td>
                  <a target="_blank" href="{$system['system_url']}/comunidade/developers/edit/{$row['app_auth_id']}">
                ...
                <td>
                  <a data-toggle="tooltip" data-placement="top" title='{__("Edit")}' href="{$system['system_url']}/comunidade/developers/edit/{$row['app_auth_id']}" class="btn btn-sm btn-icon btn-rounded btn-primary">
