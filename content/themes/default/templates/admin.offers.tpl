<div class="card">
  <div class="card-header with-icon">
    {if $sub_view == "find"}
      <div class="float-right">
        <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/offers" class="btn btn-sm btn-light">
          <i class="fa fa-arrow-circle-left mr5"></i>{__("Go Back")}
        </a>
      </div>
    {elseif $sub_view == "categories"}
      <div class="float-right">
        <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/offers/add_category" class="btn btn-sm btn-primary">
          <i class="fa fa-plus mr5"></i>{__("Add New Category")}
        </a>
      </div>
    {elseif $sub_view == "add_category" || $sub_view == "edit_category"}
      <div class="float-right">
        <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/offers/categories" class="btn btn-sm btn-light">
          <i class="fa fa-arrow-circle-left mr5"></i>{__("Go Back")}
        </a>
      </div>
    {/if}
  ...
  {if $sub_view == "" || $sub_view == "find"}
    ...
    <div class="card-body">
      ...
      <!-- search form -->
      <div class="mb20">
        <form class="form-inline" action="{$system['system_url']}/comunidade/{$control_panel['url']}/offers/find" method="get">
            ...
            {if $rows}
              {foreach $rows as $row}
                <tr>
                  ...
                  <td>
                    <a class="btn btn-sm btn-light" href="{$system['system_url']}/comunidade/posts/{$row['post_id']}" target="_blank">
