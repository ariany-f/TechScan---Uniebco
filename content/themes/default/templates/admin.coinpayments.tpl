  ...
  <div class="card-body">
    ...
    {if !$system['coinpayments_enabled']}
      <div class="alert alert-warning">
        ...
        <div class="text pt5">
          {__("CoinPayments is disabled")}, {__("Make sure you have configured")} <a class="alert-link" href="{$system['system_url']}/comunidade/{$control_panel['url']}/settings/payments">{__("Payments Settings")}</a>
        </div>
      </div>
    {/if}
