    ...
    <div class="col-12 offcanvas-mainbar">
      ...
      <div class="profile-header">
        ...
        <div class="profile-name-wrapper">
          <a href="{$system['system_url']}/comunidade/pages/{$spage['page_name']}">{$spage['page_title']}</a>
          ...
          {if $spage['i_admin']}
            {if $system['packages_enabled']}
              ...
              {if $user->_data['can_boost_pages']}
                ...
                {/if}
              {else}
                <a href="{$system['system_url']}/comunidade/packages" class="btn btn-sm btn-danger">
              ...
              <div class="d-inline-block dropdown ml5">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                  ...
                  {if $user->_is_admin}
                    ...
                    <a class="dropdown-item" href="{$system['system_url']}/comunidade/admincp/pages/edit_page/{$spage['page_id']}">
                      <i class="fa fa-cog fa-fw mr10"></i>{__("Edit in Admin Panel")}
                    </a>
                  {elseif $user->_is_moderator}
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item" href="{$system['system_url']}/comunidade/modcp/pages/edit_page/{$spage['page_id']}">
        ...
        <div class="profile-tabs-wrapper custom-scrollbar">
          <ul>
            <li>
              <a href="{$system['system_url']}/comunidade/pages/{$spage['page_name']}" {if $view == ""}class="active" {/if}>
                <i class="fa fa-newspaper fa-fw mr5"></i>{__("Timeline")}
              </a>
            </li>
            <li>
              <a href="{$system['system_url']}/comunidade/pages/{$spage['page_name']}/photos" {if $view == "photos" || $view == "albums" || $view == "album"}class="active" {/if}>
                <i class="fa fa-images fa-fw mr5"></i>{__("Photos")}
              </a>
            </li>
            <li>
              <a href="{$system['system_url']}/comunidade/pages/{$spage['page_name']}/videos" {if $view == "videos"}class="active" {/if}>
                <i class="fa fa-video fa-fw mr5"></i>{__("Videos")}
              </a>
            </li>
            {if $spage['i_like']}
              <li>
                <a href="{$system['system_url']}/comunidade/pages/{$spage['page_name']}/invites" {if $view == "invites"}class="active" {/if}>
            ...
            {if $spage['i_admin']}
              <li>
                <a href="{$system['system_url']}/comunidade/pages/{$spage['page_name']}/settings" {if $view == "settings"}class="active" {/if}>
            ...
            {if $spage['photos']}
              <div class="card panel-photos">
                <div class="card-header bg-transparent">
                  ...
                  <strong><a href="{$system['system_url']}/comunidade/pages/{$spage['page_name']}/photos">{__("Photos")}</a></strong>
                </div>
              ...
              <div class="card">
                <div class="card-header bg-transparent">
                  <div class="float-right">
                    <small><a href="{$system['system_url']}/comunidade/pages/{$spage['page_name']}/invites">{__("See All")}</a></small>
                  </div>
                  <i class="fa fa-user-tag mr5"></i>
                  <strong><a href="{$system['system_url']}/comunidade/pages/{$spage['page_name']}/invites">{__("Invite Friends")}</a></strong>
                </div>
                <div class="card-body">
                  <ul>
            ...
            <div class="card panel-photos">
              <div class="card-header with-icon with-nav">
                ...
                <ul class="nav nav-tabs">
                  <li class="nav-item">
                    <a class="nav-link active" href="{$system['system_url']}/comunidade/pages/{$spage['page_name']}/photos">{__("Photos")}</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="{$system['system_url']}/comunidade/pages/{$spage['page_name']}/albums">{__("Albums")}</a>
                  </li>
                </ul>
                <!-- panel nav -->
              </div>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header with-icon with-nav">
                ...
                <ul class="nav nav-tabs">
                  <li class="nav-item">
                    <a class="nav-link" href="{$system['system_url']}/comunidade/pages/{$spage['page_name']}/photos">{__("Photos")}</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link active" href="{$system['system_url']}/comunidade/pages/{$spage['page_name']}/albums">{__("Albums")}</a>
                  </li>
                </ul>
                <!-- panel nav -->
              </div>
          ...
          <div class="col-12">
            <div class="card panel-photos">
              <div class="card-header with-icon with-nav">
                <!-- back to albums -->
                <div class="float-right">
                  <a href="{$system['system_url']}/comunidade/pages/{$spage['page_name']}/albums" class="btn btn-sm btn-light">
                ...
                <ul class="side-nav">
                  ...
                  {if $user->_data['user_id'] == $spage['page_admin']}
                    <li {if $sub_view == "delete"}class="active" {/if}>
                      <a href="{$system['system_url']}/comunidade/pages/{$spage['page_name']}/settings/delete">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        <div class="input-group-prepend">
                          <span class="input-group-text d-none d-sm-block">{$system['system_url']}/comunidade/pages/</span>
                        </div>
