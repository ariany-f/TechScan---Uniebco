      ...
      <div class="content-tabs rounded-sm shadow-sm clearfix">
        <ul>
          <li {if $view == ""}class="active" {/if}>
            <a href="{$system['system_url']}/comunidade/pages">{__("Discover")}</a>
          </li>
          {if $user->_logged_in}
            <li {if $view == "liked"}class="active" {/if}>
              <a href="{$system['system_url']}/comunidade/pages/liked">{__("Liked Pages")}</a>
            </li>
            <li {if $view == "manage"}class="active" {/if}>
              <a href="{$system['system_url']}/comunidade/pages/manage">{__("My Pages")}</a>
            </li>
          {/if}
        </ul>
