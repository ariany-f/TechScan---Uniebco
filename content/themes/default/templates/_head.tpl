...
<html data-lang="{$system['language']['code']}" {if $system['language']['dir'] == "RTL"} dir="RTL" {/if}>
  ...
  <head>
    ...
    {if $system['system_favicon_default']}
      <link rel="shortcut icon" href="{$system['system_url']}/comunidade/content/themes/{$system['theme']}/images/favicon.png" />
    ...
    {if $system['language']['dir'] == "LTR"}
      ...
      <link rel="stylesheet" type='text/css' href="{$system['system_url']}/comunidade/content/themes/{$system['theme']}/css/style.min.css?v={time()}">
    {else}
      <link rel="stylesheet" href="https://cdn.rtlcss.com/bootstrap/v4.5.3/css/bootstrap.min.css" integrity="sha384-JvExCACAZcHNJEc7156QaHXTnQL3hQBixvj5RV5buE7vgnNEzzskDtx9NQ4p6BJe" crossorigin="anonymous">
      <link rel="stylesheet" type='text/css' href="{$system['system_url']}/comunidade/content/themes/{$system['theme']}/css/style.rtl.min.css">
    {/if}
    <!-- CSS -->
