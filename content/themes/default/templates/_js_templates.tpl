{strip}
  ...
  <script id="modal-login" type="text/template">
    ...
    <div class="modal-footer">
      <a class="btn btn-primary" href="{$system['system_url']}/comunidade/signin">{__("Login")}</a>
    </div>
  </script>
          ...
          <div class="col-6">
            <div style="background: rgb(0 0 0 / 0.06); padding: 8px; border-radius: 8px; margin-bottom: 30px;">
              <a style="display: block; position: relative; padding-bottom: 60%;" href="?theme={$theme['name']}">
                <img style="width: 100%; height: 100%; position: absolute; top: 0; right: 0; bottom: 0; left: 0; border-radius: 4px;" src="{$system['system_url']}/comunidade/content/themes/{$theme['name']}/thumbnail.png">
  ...
  <script id="search-for" type="text/template">
    <div class="ptb10 plr10">
      <a href="{$system['system_url']}/comunidade/search/{literal}{{#hashtag}}hashtag/{{/hashtag}}{/literal}{literal}{{query}}{/literal}">
      ...
      <div class="chat-sidebar {if !$user->_data['user_chat_enabled']}disabled{/if}">
        <div class="chat-sidebar-header">
          <div class="float-right">
            <a class="js_chat-new mr5" href="{$system['system_url']}/comunidade/messages/new">
              <i class="fa fa-edit"></i>
            </a>
            <i class="fa fa-cog" data-toggle="dropdown" data-display="static"></i>
            <div class="dropdown-menu dropdown-menu-right">
              <a class="dropdown-item" href="{$system['system_url']}/comunidade/settings/blocking">{__("Manage Blocking")}</a>
              <a class="dropdown-item" href="{$system['system_url']}/comunidade/settings/privacy">{__("Privacy Settings")}</a>
    ...
    <script id="chat-box" type="text/template">
      <div class="chat-widget chat-box opened" id="{literal}{{chat_key_value}}{/literal}" {literal}{{#conversation_id}}{/literal}data-cid="{literal}{{conversation_id}}{/literal}" {literal}{{/conversation_id}}{/literal} {literal}{{#user_id}}{/literal}data-uid="{literal}{{user_id}}{/literal}" {literal}{{/user_id}}{/literal}>
        ...
        <div class="chat-widget-head js_chat-color-me">
          ...
          <a href="{$system['system_url']}/comunidade/{literal}{{link}}{/literal}" title="{literal}{{name_list}}{/literal}">{literal}{{name}}{/literal}</a>
          {literal}{{/multiple}}{/literal}
          {literal}{{#multiple}}{/literal}
          <a href="{$system['system_url']}/comunidade/messages/{literal}{{link}}{/literal}" title="{literal}{{name_list}}{/literal}">{literal}{{name}}{/literal}</a>
          {literal}{{/multiple}}{/literal}
          <!-- label -->
      ...
      <script id="download-information" type="text/template">
        ...
        <div class="modal-body">
          <div class="text-center">
            ...
            <a href="{$system['system_url']}/comunidade/settings/download?hash={$user->_data['user_name']}-{$secret}" class="btn btn-md btn-primary bg-gradient-blue border-0 rounded-pill">
    ...
    {if $page == "packages" || $page == "ads" || $page == "wallet" || ($page == "index" || $page == "profile" || $page == "page" || $page == "group" || $page == "post" || $page == "directory" || $page == "search")}
            ...
            {if $system['cashfree_enabled']}
              <div class="col-12 col-sm-4 plr5">
                <button class="btn btn-block btn-payment plr20 mb10" data-toggle="modal" data-url="#cashfree" data-options='{literal}{{/literal} "handle": "{literal}{{handle}}{/literal}", "id": "{literal}{{id}}{/literal}", "price": "{literal}{{price}}{/literal}" {literal}}{/literal}'>
                  <img width="20px" height="20px" src="{$system['system_url']}/comunidade/content/themes/{$system['theme']}/images/cashfree.png" class="mr5">{__("Cashfree")}
                </button>
              </div>
            {/if}
      ...
      {if $system['cashfree_enabled']}
        <script id="cashfree" type="text/template">
          <div class="modal-header">
            <h6 class="modal-title"><img width="20px" height="20px" src="{$system['system_url']}/comunidade/content/themes/{$system['theme']}/images/cashfree.png" class="mr5">{__("Cashfree")}</h6>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
