    ...
    <div class="col-12 offcanvas-mainbar">
      ...
      <div class="profile-header">
        ...
        <div class="profile-name-wrapper">
          <a href="{$system['system_url']}/comunidade/{$profile['user_name']}">{$profile['name']}</a>
          ...
          {if $profile['user_subscribed']}
            <a href="{$system['system_url']}/comunidade/packages" class="badge badge-warning" data-toggle="tooltip" data-placement="top" title="{__($profile['package_name'])} {__('Member')}">{__("PRO")}</a>
          {/if}
        </div>
        <!-- profile-name -->
        ...
        <div class="profile-buttons-wrapper">
          {if $user->_logged_in}
              ...
              <div class="d-inline-block dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                  ...
                  {if $user->_is_admin}
                    ...
                    <a class="dropdown-item" href="{$system['system_url']}/comunidade/admincp/users/edit/{$profile['user_id']}">
                      <i class="fa fa-cog fa-fw mr10"></i>{__("Edit in Admin Panel")}
                    </a>
                  {elseif $user->_is_moderator}
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item" href="{$system['system_url']}/comunidade/modcp/users/edit/{$profile['user_id']}">
            ...
            {else}
              <!-- edit -->
              <a href="{$system['system_url']}/comunidade/settings/profile" class="btn btn-icon btn-rounded btn-light">
        ...
        <div class="profile-tabs-wrapper custom-scrollbar">
          <ul>
            <li>
              <a href="{$system['system_url']}/comunidade/{$profile['user_name']}" {if $view == ""}class="active" {/if}>
                <i class="fa fa-newspaper fa-fw mr5"></i>{__("Timeline")}
              </a>
            </li>
            <li>
              <a href="{$system['system_url']}/comunidade/{$profile['user_name']}/friends" {if $view == "friends" || $view == "followers" || $view == "followings"}class="active" {/if}>
                <i class="fa fa-users fa-fw mr5"></i>{__("Friends")}
              </a>
            </li>
            <li>
              <a href="{$system['system_url']}/comunidade/{$profile['user_name']}/photos" {if $view == "photos" || $view == "albums" || $view == "album"}class="active" {/if}>
                <i class="fa fa-images fa-fw mr5"></i>{__("Photos")}
              </a>
            </li>
            <li>
              <a href="{$system['system_url']}/comunidade/{$profile['user_name']}/videos" {if $view == "videos"}class="active" {/if}>
                <i class="fa fa-video fa-fw mr5"></i>{__("Videos")}
              </a>
            </li>
            {if $system['pages_enabled']}
              <li>
                <a href="{$system['system_url']}/comunidade/{$profile['user_name']}/likes" {if $view == "likes"}class="active" {/if}>
            ...
            {if $system['groups_enabled']}
              <li>
                <a href="{$system['system_url']}/comunidade/{$profile['user_name']}/groups" {if $view == "groups"}class="active" {/if}>
            ...
            {if $system['events_enabled']}
              <li>
                <a href="{$system['system_url']}/comunidade/{$profile['user_name']}/events" {if $view == "events"}class="active" {/if}>
                  ...
                  <div class="mt10 clearfix">
                    <ul class="float-left mr20">
                      {foreach $profile['mutual_friends'] as $mutual_friend}
                        <li>
                          <a data-toggle="tooltip" data-placement="top" title="{if $system['show_usernames_enabled']}{$mutual_friend['user_name']}{else}{$mutual_friend['user_firstname']} {$mutual_friend['user_lastname']}{/if}" class="post-avatar-picture" href="{$system['system_url']}/comunidade/{$mutual_friend['user_name']}" style="background-image:url({$mutual_friend['user_picture']});">
                          </a>
                        </li>
                ...
                <ul class="about-list">
                  ...
                  <li>
                    <div class="about-list-item">
                      ...
                      {__("Followed by")}
                      <a href="{$system['system_url']}/comunidade/{$profile['user_name']}/followers">{$profile['followers_count']} {__("people")}</a>
                    </div>
                  </li>
                </ul>
              </div>
          ...
          <div class="order-2 col-lg-3 order-lg-3">
            ...
            {if $profile['photos']}
              <div class="card panel-photos">
                <div class="card-header bg-transparent">
                  ...
                  <strong><a href="{$system['system_url']}/comunidade/{$profile['user_name']}/photos">{__("Photos")}</a></strong>
                </div>
            ...
            {if $profile['friends_count'] > 0}
              <div class="card">
                <div class="card-header bg-transparent">
                  ...
                  <strong><a href="{$system['system_url']}/comunidade/{$profile['user_name']}/friends">{__("Friends")}</a></strong>
                    ...
                    {foreach $profile['friends'] as $_friend}
                      <div class="col-3 col-lg-4">
                        <div class="circled-user-box">
                          <a class="user-box" href="{$system['system_url']}/comunidade/{$_friend['user_name']}">
            ...
            {if $system['pages_enabled'] && count($profile['pages']) > 0}
              <div class="card">
                <div class="card-header bg-transparent">
                  ...
                  <strong><a href="{$system['system_url']}/comunidade/{$profile['user_name']}/likes">{__("Likes")}</a></strong>
                </div>
                <div class="card-body ptb10 plr10">
                  <div class="row no-gutters">
                    {foreach $profile['pages'] as $_page}
                      <div class="col-3 col-lg-4">
                        <div class="circled-user-box">
                          <a class="user-box" href="{$system['system_url']}/comunidade/pages/{$_page['page_name']}">
            ...
            {if $system['groups_enabled'] && count($profile['groups']) > 0}
              <div class="card">
                <div class="card-header bg-transparent">
                  <i class="fa fa-users mr5"></i>
                  <strong><a href="{$system['system_url']}/comunidade/{$profile['user_name']}/groups">{__("Groups")}</a></strong>
                </div>
                <div class="card-body ptb10 plr10">
                  <div class="row no-gutters">
                    {foreach $profile['groups'] as $_group}
                      <div class="col-3 col-lg-4">
                        <div class="circled-user-box">
                          <a class="user-box" href="{$system['system_url']}/comunidade/groups/{$_group['group_name']}">
            ...
            {if $system['events_enabled'] && count($profile['events']) > 0}
              <div class="card">
                <div class="card-header bg-transparent">
                  ...
                  <strong><a href="{$system['system_url']}/comunidade/{$profile['user_name']}/events">{__("Events")}</a></strong>
                </div>
                <div class="card-body ptb10 plr10">
                  <div class="row no-gutters">
                    {foreach $profile['events'] as $_event}
                      <div class="col-3 col-lg-4">
                        <div class="circled-user-box">
                          <a class="user-box" href="{$system['system_url']}/comunidade/events/{$_event['event_id']}">
            ...
            <div class="card">
              <div class="card-header with-icon with-nav">
                ...
                <ul class="nav nav-tabs">
                  <li class="nav-item">
                    <a class="nav-link active" href="{$system['system_url']}/comunidade/{$profile['user_name']}/friends">
                      {__("Friends")}
                      <span class="badge badge-pill badge-info">{$profile['friends_count']}</span>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="{$system['system_url']}/comunidade/{$profile['user_name']}/followers">{__("Followers")}</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="{$system['system_url']}/comunidade/{$profile['user_name']}/followings">{__("Followings")}</a>
                  </li>
                </ul>
                <!-- panel nav -->
              </div>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header with-icon with-nav">
                ...
                <ul class="nav nav-tabs">
                  <li class="nav-item">
                    <a class="nav-link" href="{$system['system_url']}/comunidade/{$profile['user_name']}/friends">{__("Friends")}</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link active" href="{$system['system_url']}/comunidade/{$profile['user_name']}/followers">
                      {__("Followers")}
            ...
            <div class="card">
              <div class="card-header with-icon with-nav">
                ...
                <ul class="nav nav-tabs">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="{$system['system_url']}/comunidade/{$profile['user_name']}/followers">
                      <strong class="pr5">{__("Followers")}</strong>
                      <span class="badge badge-pill badge-info">{$profile['followers_count']}</span>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link active" href="{$system['system_url']}/comunidade/{$profile['user_name']}/followings">
                      {__("Followings")}
          ...
          <div class="col-12">
            <div class="card panel-photos">
              <div class="card-header with-icon with-nav">
                ...
                <ul class="nav nav-tabs">
                  <li class="nav-item">
                    <a class="nav-link active" href="{$system['system_url']}/comunidade/{$profile['user_name']}/photos">{__("Photos")}</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="{$system['system_url']}/comunidade/{$profile['user_name']}/albums">{__("Albums")}</a>
                  </li>
                </ul>
                <!-- panel nav -->
              </div>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header with-icon with-nav">
                ...
                <ul class="nav nav-tabs">
                  <li class="nav-item">
                    <a class="nav-link" href="{$system['system_url']}/comunidade/{$profile['user_name']}/photos">{__("Photos")}</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link active" href="{$system['system_url']}/comunidade/{$profile['user_name']}/albums">{__("Albums")}</a>
                  </li>
                </ul>
                <!-- panel nav -->
              </div>
          ...
          <div class="col-12">
            <div class="card panel-photos">
              <div class="card-header with-icon with-nav">
                <!-- back to albums -->
                <div class="float-right">
                  <a href="{$system['system_url']}/comunidade/{$profile['user_name']}/albums" class="btn btn-sm btn-light">
