<li class="feeds-item {if !$conversation['seen']}unread{/if}" data-last-message="{$conversation['last_message_id']}">
  {if $conversation['multiple_recipients']}
    <a class="data-container js_chat-start" data-cid="{$conversation['conversation_id']}" data-name="{$conversation['name']}" data-name-list="{$conversation['name_list']}" data-link="{$conversation['link']}" data-multiple="true" href="{$system['system_url']}/comunidade/messages/{$conversation['conversation_id']}">
  ...
  {else}
    <a class="data-container js_chat-start" data-cid="{$conversation['conversation_id']}" data-uid="{$conversation['user_id']}" data-name="{$conversation['name']}" data-name-list="{$conversation['name_list']}" data-link="{$conversation['link']}" href="{$system['system_url']}/comunidade/messages/{$conversation['conversation_id']}">
      <div class="data-avatar">
