    ...
    <div class="col-12 col-md-8 col-lg-10 offcanvas-mainbar">
      ...
      <div class="profile-header no-avatar">
        ...
        <div class="profile-name-wrapper">
          <a href="{$system['system_url']}/comunidade/events/{$event['event_id']}">{$event['event_title']}</a>
              ...
              <div class="d-inline-block dropdown ml5">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                  ...
                  {if $user->_is_admin}
                    ...
                    <a class="dropdown-item" href="{$system['system_url']}/comunidade/admincp/events/edit_event/{$event['event_id']}">
                      <i class="fa fa-cog fa-fw mr10"></i>{__("Edit in Admin Panel")}
                    </a>
                  {elseif $user->_is_moderator}
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item" href="{$system['system_url']}/comunidade/modcp/events/edit_event/{$event['event_id']}">
        ...
        <div class="profile-tabs-wrapper custom-scrollbar">
          <ul>
            {if $event['event_privacy'] == "public" || $event['i_joined'] || $event['i_admin']}
              <li>
                <a href="{$system['system_url']}/comunidade/events/{$event['event_id']}" {if $view == ""}class="active" {/if}>
                  <i class="fa fa-newspaper fa-fw mr5"></i>{__("Timeline")}
                </a>
              </li>
              <li>
                <a href="{$system['system_url']}/comunidade/events/{$event['event_id']}/photos" {if $view == "photos" || $view == "albums" || $view == "album"}class="active" {/if}>
                  <i class="fa fa-images fa-fw mr5"></i>{__("Photos")}
                </a>
              </li>
              <li>
                <a href="{$system['system_url']}/comunidade/events/{$event['event_id']}/videos" {if $view == "videos"}class="active" {/if}>
                  <i class="fa fa-video fa-fw mr5"></i>{__("Videos")}
                </a>
              </li>
              <li>
                <a href="{$system['system_url']}/comunidade/events/{$event['event_id']}/going" {if $view == "going" || $view == "interested" || $view == "invited" || $view == "invites"}class="active" {/if}>
                  <i class="fa fa-users fa-fw mr5"></i>{__("Members")}
                </a>
              </li>
              {if $event['i_admin']}
                <li>
                  <a href="{$system['system_url']}/comunidade/events/{$event['event_id']}/settings" {if $view == "settings"}class="active" {/if}>
            ...
            {else}
              <li>
                <a href="{$system['system_url']}/comunidade/events/{$event['event_id']}" {if $view == "about"}class="active" {/if}>
                ...
                <ul class="about-list">
                  ...
                  <li>
                    <div class="about-list-item">
                      ...
                      {__("Hosted By")} <a target="_blank" href="{$system['system_url']}/comunidade/{$event['user_name']}">{if $system['show_usernames_enabled']}{$event['user_name']}{else}{$event['user_firstname']} {$event['user_lastname']}{/if}</a>
                    </div>
                  </li>
                  <li>
                    <div class="about-list-item">
                  ...
                  <li>
                    <div class="about-list-item">
                      ...
                      <a href="{$system['system_url']}/comunidade/events/{$event['event_id']}/going">{$event['event_going']} {__("Going")}</a>
                    </div>
                  </li>
                  <li>
                    <div class="about-list-item">
                      <i class="fa fa-star fa-fw fa-lg"></i>
                      <a href="{$system['system_url']}/comunidade/events/{$event['event_id']}/interested">{$event['event_interested']} {__("Interested")}</a>
                    </div>
                  </li>
                  <li>
                    <div class="about-list-item">
                      <i class="fa fa-envelope-open fa-fw fa-lg"></i>
                      <a href="{$system['system_url']}/comunidade/events/{$event['event_id']}/invited">{$event['event_invited']} {__("Invited")}</a>
                    </div>
                  </li>
                </ul>
              </div>
              ...
              <div class="card">
                <div class="card-header bg-transparent">
                  <div class="float-right">
                    <small><a href="{$system['system_url']}/comunidade/events/{$event['event_id']}/invites">{__("See All")}</a></small>
                  </div>
                  <i class="fa fa-user-tag mr5"></i>
                  <strong><a href="{$system['system_url']}/comunidade/events/{$event['event_id']}/invites">{__("Invite Friends")}</a></strong>
                </div>
                <div class="card-body">
                  <ul>
            ...
            {if $event['photos']}
              <div class="card panel-photos">
                <div class="card-header bg-transparent">
                  ...
                  <strong><a href="{$system['system_url']}/comunidade/events/{$event['event_id']}/photos">{__("Photos")}</a></strong>
                </div>
            ...
            <div class="card panel-photos">
              <div class="card-header with-icon with-nav">
                ...
                <ul class="nav nav-tabs">
                  <li class="nav-item">
                    <a class="nav-link active" href="{$system['system_url']}/comunidade/events/{$event['event_id']}/photos">{__("Photos")}</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="{$system['system_url']}/comunidade/events/{$event['event_id']}/albums">{__("Albums")}</a>
                  </li>
                </ul>
                <!-- panel nav -->
              </div>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header with-icon with-nav">
                ...
                <ul class="nav nav-tabs">
                  <li class="nav-item">
                    <a class="nav-link" href="{$system['system_url']}/comunidade/events/{$event['event_id']}/photos">{__("Photos")}</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link active" href="{$system['system_url']}/comunidade/events/{$event['event_id']}/albums">{__("Albums")}</a>
                  </li>
                </ul>
                <!-- panel nav -->
              </div>
          ...
          <div class="col-12">
            <div class="card panel-photos">
              <div class="card-header with-icon with-nav">
                <!-- back to albums -->
                <div class="float-right">
                  <a href="{$system['system_url']}/comunidade/events/{$event['event_id']}/albums" class="btn btn-sm btn-light">
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header with-icon with-nav">
                ...
                <ul class="nav nav-tabs">
                  <li class="nav-item">
                    <a class="nav-link {if $view == "going"}active{/if}" href="{$system['system_url']}/comunidade/events/{$event['event_id']}/going">
                      {__("Going")}
                      <span class="badge badge-pill badge-info">{$event['event_going']}</span>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link {if $view == "interested"}active{/if}" href="{$system['system_url']}/comunidade/events/{$event['event_id']}/interested">
                      {__("Interested")}
                      <span class="badge badge-pill badge-info">{$event['event_interested']}</span>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link {if $view == "invited"}active{/if}" href="{$system['system_url']}/comunidade/events/{$event['event_id']}/invited">
                      {__("Invited")}
                  ...
                  {if $event['i_joined']}
                    <li class="nav-item">
                      <a class="nav-link {if $view == "invites"}active{/if}" href="{$system['system_url']}/comunidade/events/{$event['event_id']}/invites">
                        {__("Invites")}
                      </a>
                    </li>
                  {/if}
              ...
              <div class="card-body with-nav">
                <ul class="side-nav">
                  <li {if $sub_view == ""}class="active" {/if}>
                    <a href="{$system['system_url']}/comunidade/events/{$event['event_id']}/settings"><i class="fa fa-cog fa-fw mr5"></i>{__("Event Settings")}</a>
                  </li>
                  <li {if $sub_view == "delete"}class="active" {/if}>
                    <a href="{$system['system_url']}/comunidade/events/{$event['event_id']}/settings/delete"><i class="fa fa-trash fa-fw mr5"></i>{__("Delete Event")}</a>
                  </li>
                </ul>
              </div>
            </div>
