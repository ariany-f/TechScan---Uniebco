            ...
            <div class="post-header mb0">
              ...
              <div class="post-meta">
                <div class="float-right">
                  <a href="{$system['system_url']}/comunidade/games" class="btn btn-sm btn-light d-none d-lg-block">
                    <i class="fa fa-arrow-circle-left mr5"></i>{__("Go Back")}
                  </a>
                  <a href="{$system['system_url']}/comunidade/games" class="btn btn-sm btn-icon btn-light d-block d-lg-none">
        ...
        <div class="content-tabs rounded-sm shadow-sm clearfix">
          <ul>
            <li {if $view == ""}class="active" {/if}>
              <a href="{$system['system_url']}/comunidade/games">{__("Discover")}</a>
            </li>
            {if $user->_logged_in}
              <li {if $view == "played"}class="active" {/if}>
                <a href="{$system['system_url']}/comunidade/games/played">{__("Your Games")}</a>
              </li>
            {/if}
          </ul>
        </div>
