        ...
        <div class="form-group form-row">
          ...
          <div class="col-md-9">
            ...
            <span class="form-text">
              ...
              {__("Make sure you have enabled")} <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/settings/posts">{__("Posts Views System")}</a>
            </span>
          </div>
        </div>
        ...
        <div class="form-group form-row">
          ...
          <div class="col-md-9">
            ...
            <span class="form-text">
              ...
              {__("Make sure you have enabled")} <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/affiliates">{__("Affiliates System")}</a>
            </span>
          </div>
        </div>
