...
<div class="container offcanvas">
  <div class="row">
    ...
    <!-- side panel -->
    <div class="col-12 col-md-4 col-lg-2 d-block d-sm-none d-md-block offcanvas-sidebar js_sticky-sidebar">
      {include file='_sidebar.tpl'}
    </div>
    <!-- side panel -->

    <!-- content panel -->
    <div class="col-12 col-md-8 col-lg-10 offcanvas-mainbar">
      <!-- profile-header -->
      <div class="profile-header">
        ...
        <div class="profile-name-wrapper">
          <a href="{$system['system_url']}/comunidade/groups/{$group['group_name']}">{$group['group_title']}</a>
              ...
              <div class="d-inline-block dropdown ml5">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                  ...
                  {if $user->_is_admin}
                    ...
                    <a class="dropdown-item" href="{$system['system_url']}/comunidade/admincp/groups/edit_group/{$group['group_id']}">
                      <i class="fa fa-cog fa-fw mr10"></i>{__("Edit in Admin Panel")}
                    </a>
                  {elseif $user->_is_moderator}
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item" href="{$system['system_url']}/comunidade/modcp/groups/edit_group/{$group['group_id']}">
        ...
        <div class="profile-tabs-wrapper narrow custom-scrollbar">
          <ul>
            {if $group['group_privacy'] == "closed" && $group['i_joined'] != "approved" && !$group['i_admin']}
              <li>
                <a href="{$system['system_url']}/comunidade/groups/{$group['group_name']}">
                  <i class="fa fa-info-circle fa-fw mr5"></i>{__("About")}
                </a>
              </li>
            {else}
              <li>
                <a href="{$system['system_url']}/comunidade/groups/{$group['group_name']}" {if $view == ""}class="active" {/if}>
                  <i class="fa fa-newspaper fa-fw mr5"></i>{__("Timeline")}
                </a>
              </li>
              <li>
                <a href="{$system['system_url']}/comunidade/groups/{$group['group_name']}/photos" {if $view == "photos" || $view == "albums" || $view == "album"}class="active" {/if}>
                  <i class="fa fa-images fa-fw mr5"></i>{__("Photos")}
                </a>
              </li>
              <li>
                <a href="{$system['system_url']}/comunidade/groups/{$group['group_name']}/videos" {if $view == "videos"}class="active" {/if}>
                  <i class="fa fa-video fa-fw mr5"></i>{__("Videos")}
                </a>
              </li>
              {if !$group['i_admin']}
                <li>
                  <a href="{$system['system_url']}/comunidade/groups/{$group['group_name']}/members" {if $view == "members" || $view == "invites"}class="active" {/if}>
                    <i class="fa fa-users fa-fw mr5"></i>{__("Members")}
                  </a>
                </li>
              {else}
                <li>
                  <a href="{$system['system_url']}/comunidade/groups/{$group['group_name']}/settings" {if $view == "settings"}class="active" {/if}>
      ...
      <div class="row">
        ...
        {if $view == ""}
          ...
          <div class="order-1 col-lg-4 order-lg-2">
                ...
                <ul class="about-list">
                  ...
                  <li>
                    <div class="about-list-item">
                      ...
                      <a href="{$system['system_url']}/comunidade/groups/{$group['group_name']}/members">{$group['group_members']} {__("members")}</a>
                    </div>
                  </li>
                  <!-- members -->
                  <!-- category -->
            ...
            <!-- invite friends -->
            {if ($group['i_joined'] == "approved" && $group['invites']) || $user->_is_admin}
              <div class="card">
                <div class="card-header bg-transparent">
                  <div class="float-right">
                    <small><a href="{$system['system_url']}/comunidade/groups/{$group['group_name']}/invites">{__("See All")}</a></small>
                  </div>
                  <i class="fa fa-user-tag mr5"></i>
                  <strong><a href="{$system['system_url']}/comunidade/groups/{$group['group_name']}/invites">{__("Invite Friends")}</a></strong>
                </div>
                <div class="card-body">
                  <ul>
            ...
            {if $group['photos']}
              <div class="card panel-photos">
                <div class="card-header bg-transparent">
                  ...
                  <strong><a href="{$system['system_url']}/comunidade/groups/{$group['group_name']}/photos">{__("Photos")}</a></strong>
                </div>
            ...
            {if $get == "posts_group"}
              ...
              {if $group['i_admin'] && $group['total_requests'] > 0}
                <div class="alert alert-info">
                  ...
                  <div class="text align-middle">
                    <a href="{$system['system_url']}/comunidade/groups/{$group['group_name']}/settings/requests" class="alert-link">
            ...
            <div class="card panel-photos">
              <div class="card-header with-icon with-nav">
                ...
                <ul class="nav nav-tabs">
                  <li class="nav-item">
                    <a class="nav-link active" href="{$system['system_url']}/comunidade/groups/{$group['group_name']}/photos">{__("Photos")}</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="{$system['system_url']}/comunidade/groups/{$group['group_name']}/albums">{__("Albums")}</a>
                  </li>
                </ul>
                <!-- panel nav -->
              </div>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header with-icon with-nav">
                ...
                <ul class="nav nav-tabs">
                  <li class="nav-item">
                    <a class="nav-link" href="{$system['system_url']}/comunidade/groups/{$group['group_name']}/photos">{__("Photos")}</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link active" href="{$system['system_url']}/comunidade/groups/{$group['group_name']}/albums">{__("Albums")}</a>
                  </li>
                </ul>
                <!-- panel nav -->
              </div>
          ...
          <div class="col-12">
            <div class="card panel-photos">
              <div class="card-header with-icon with-nav">
                <!-- back to albums -->
                <div class="float-right">
                  <a href="{$system['system_url']}/comunidade/groups/{$group['group_name']}/albums" class="btn btn-sm btn-light">
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header with-icon with-nav">
                ...
                <ul class="nav nav-tabs">
                  <li class="nav-item">
                    <a class="nav-link active" href="{$system['system_url']}/comunidade/groups/{$group['group_name']}/members">
                      {__("Members")}
                  ...
                  {if $group['i_joined'] == "approved"}
                    <li class="nav-item">
                      <a class="nav-link" href="{$system['system_url']}/comunidade/groups/{$group['group_name']}/invites">
                        {__("Invites")}
                      </a>
                    </li>
                  {/if}
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header with-icon with-nav">
                ...
                <ul class="nav nav-tabs">
                  <li class="nav-item">
                    <a class="nav-link" href="{$system['system_url']}/comunidade/groups/{$group['group_name']}/members">
                      {__("Members")}
                      <span class="badge badge-pill badge-info">{$group['group_members']}</span>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link active" href="{$system['system_url']}/comunidade/groups/{$group['group_name']}/invites">
                      {__("Invites")}
                    </a>
                  </li>
                </ul>
              ...
              <div class="card-body with-nav">
                <ul class="side-nav">
                  <li {if $sub_view == ""}class="active" {/if}>
                    <a href="{$system['system_url']}/comunidade/groups/{$group['group_name']}/settings"><i class="fa fa-cog fa-fw mr5"></i>{__("Group Settings")}</a>
                  </li>
                  {if $group['group_privacy'] != "public"}
                    <li {if $sub_view == "requests"}class="active" {/if}>
                      <a href="{$system['system_url']}/comunidade/groups/{$group['group_name']}/settings/requests"><i class="fa fa-user-plus fa-fw mr5"></i>{__("Join Requests")}</a>
                    </li>
                  {/if}
                  <li {if $sub_view == "members"}class="active" {/if}>
                    <a href="{$system['system_url']}/comunidade/groups/{$group['group_name']}/settings/members"><i class="fa fa-users fa-fw mr5"></i>{__("Members")}</a>
                  </li>
                  {if $user->_data['user_id'] == $group['group_admin']}
                    <li {if $sub_view == "delete"}class="active" {/if}>
                      <a href="{$system['system_url']}/comunidade/groups/{$group['group_name']}/settings/delete"><i class="fa fa-trash fa-fw mr5"></i>{__("Delete Group")}</a>
                    </li>
                  {/if}
                </ul>
              </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        <div class="input-group-prepend">
                          <span class="input-group-text d-none d-sm-block">{$system['system_url']}/comunidade/groups/</span>
                        </div>
