        ...
        <div class="col-sm-6">
          <div class="stat-panel bg-gradient-primary">
            <div class="stat-cell">
              ...
              <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/users">{__("Manage Users")}</a>
            </div>
          </div>
        </div>
        ...
        <div class="col-sm-6">
          <div class="stat-panel bg-gradient-teal">
            <div class="stat-cell">
              ...
              <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/users/online">{__("Manage Online")}</a>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="col-sm-6">
          <div class="stat-panel bg-gradient-red">
            <div class="stat-cell">
              ...
              <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/users/banned">{__("Manage Banned")}</a>
            </div>
          </div>
        </div>
        <div class="col-sm-6">
      ...
      <div class="col-sm-6">
        <div class="stat-panel bg-gradient-success">
          <div class="stat-cell">
            ...
            <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/posts">{__("Manage Posts")}</a>
          </div>
        </div>
      </div>
      <div class="col-sm-6">
        <div class="stat-panel bg-gradient-success">
          <div class="stat-cell">
            ...
            <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/reports">{__("Manage Reports")}</a>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="col-sm-4">
        <div class="stat-panel bg-gradient-primary">
          <div class="stat-cell">
            ...
            <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/pages">{__("Manage Pages")}</a>
          </div>
        </div>
      </div>
      <div class="col-sm-4">
        <div class="stat-panel bg-gradient-primary">
          <div class="stat-cell">
            ...
            <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/groups">{__("Manage Groups")}</a>
          </div>
        </div>
      </div>
      <div class="col-sm-4">
        <div class="stat-panel bg-gradient-primary">
          <div class="stat-cell">
            ...
            <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/events">{__("Manage Events")}</a>
          </div>
        </div>
      </div>
    </div>
