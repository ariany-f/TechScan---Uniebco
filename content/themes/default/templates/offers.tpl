...
<div class="page-header">
  <img class="floating-img d-none d-md-block" src="{$system['system_url']}/comunidade/content/themes/{$system['theme']}/images/headers/undraw_discount_d4bd.svg">
          ...
          <ul class="side-nav">
            ...
            {else}
              <li>
                {if $current_category['parent']}
                  <a href="{$system['system_url']}/comunidade/offers/category/{$current_category['parent']['category_id']}/{$current_category['parent']['category_url']}">
            ...
            {foreach $categories as $category}
              <li {if $view == "category" && $current_category['category_id'] == $category['category_id']}class="active" {/if}>
                <a href="{$system['system_url']}/comunidade/offers/category/{$category['category_id']}/{$category['category_url']}">
              ...
              <div class="card product boosted">
                ...
                <div class="product-info">
                  <div class="product-meta title">
                    <a href="{$system['system_url']}/comunidade/posts/{$post['post_id']}" class="title">{$post['offer']['meta_title']}</a>
                  </div>
                </div>
              </div>
            </div>
