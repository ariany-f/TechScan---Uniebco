<div class="card">
  <div class="card-header with-icon">
    {if $sub_view == "find"}
      <div class="float-right">
        <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/groups" class="btn btn-sm btn-light">
    ...
    {elseif $sub_view == "edit_group"}
      <div class="float-right">
        ...
        <a target="_blank" href="{$system['system_url']}/comunidade/groups/{$data['group_name']}" class="btn btn-sm btn-info">
          <i class="fa fa-tv"></i><span class="ml5 d-none d-lg-inline-block">{__("View Group")}</span>
        </a>
      </div>
    {elseif $sub_view == "categories"}
      <div class="float-right">
        <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/groups/add_category" class="btn btn-sm btn-primary">
    ...
    {elseif $sub_view == "add_category" || $sub_view == "edit_category"}
      <div class="float-right">
        <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/groups/categories" class="btn btn-sm btn-light">
          <i class="fa fa-arrow-circle-left"></i><span class="ml5 d-none d-lg-inline-block">{__("Go Back")}</span>
        </a>
      </div>
    {/if}
  ...
  {if $sub_view == "" || $sub_view == "find"}
    ...
    <div class="card-body">
      ...
      <!-- search form -->
      <div class="mb20">
        <form class="form-inline" action="{$system['system_url']}/comunidade/{$control_panel['url']}/groups/find" method="get">
          ...
          <tbody>
            {if $rows}
              {foreach $rows as $row}
                <tr>
                  <td>
                    <a href="{$system['system_url']}/comunidade/groups/{$row['group_name']}" target="_blank">{$row['group_id']}</a>
                  </td>
                  <td>
                    <a target="_blank" href="{$system['system_url']}/comunidade/groups/{$row['group_name']}">
                  ...
                  <td>
                    <a data-toggle="tooltip" data-placement="top" title='{__("Edit")}' href="{$system['system_url']}/comunidade/{$control_panel['url']}/groups/edit_group/{$row['group_id']}" class="btn btn-sm btn-icon btn-rounded btn-primary">
  ...
  {elseif $sub_view == "edit_group"}
    ...
    <form class="js_ajax-forms" data-url="admin/groups.php?do=edit_group&id={$data['group_id']}">
        ...
        <div class="tab-content">
          ...
          <div class="tab-pane active" id="group_settings">
            <div class="form-group form-row">
              ...
              <div class="col-md-9">
                <a target="_blank" href="{$system['system_url']}/comunidade/{$data['user_name']}">
                ...
                <a target="_blank" data-toggle="tooltip" data-placement="top" title='{__("Edit")}' href="{$system['system_url']}/comunidade/{$control_panel['url']}/users/edit/{$data['user_id']}" class="btn btn-sm btn-light btn-icon btn-rounded ml10">
                  <i class="fa fa-pencil-alt"></i>
                </a>
              </div>
            </div>
      ...
      <div class="card-footer text-right">
        ...
        <button type="button" class="btn btn-danger js_admin-deleter" data-handle="group" data-id="{$data['group_id']}" data-redirect="{$system['system_url']}/comunidade/{$control_panel['url']}/groups">
