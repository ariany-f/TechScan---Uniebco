  ...
  <div class="card-header with-icon">
    {if $sub_view == ""}
      <div class="float-right">
        <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/movies/add_movie" class="btn btn-sm btn-primary">
          <i class="fa fa-plus mr5"></i>{__("Add New Movie")}
        </a>
      </div>
    {elseif $sub_view == "genres"}
      <div class="float-right">
        <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/movies/add_genre" class="btn btn-sm btn-primary">
          <i class="fa fa-plus mr5"></i>{__("Add New Genre")}
        </a>
      </div>
    {elseif $sub_view == "add_movie" || $sub_view == "edit_movie"}
      <div class="float-right">
        <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/movies" class="btn btn-sm btn-light">
          <i class="fa fa-arrow-circle-left mr5"></i>{__("Go Back")}
        </a>
      </div>
    {elseif $sub_view == "add_genre" || $sub_view == "edit_genre"}
      <div class="float-right">
        <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/movies/genres" class="btn btn-sm btn-light">
          <i class="fa fa-arrow-circle-left mr5"></i>{__("Go Back")}
        </a>
      </div>
    {/if}
          ...
          <tbody>
            {foreach $rows as $row}
              <tr>
                ...
                <td>
                  <a target="_blank" href="{$system['system_url']}/comunidade/movie/{$row['movie_id']}/{$row['movie_url']}">
                ...
                <td>
                  <a data-toggle="tooltip" data-placement="top" title='{__("Edit")}' href="{$system['system_url']}/comunidade/{$control_panel['url']}/movies/edit_movie/{$row['movie_id']}" class="btn btn-sm btn-icon btn-rounded btn-primary">
        ...
        <div class="form-group form-row">
          ...
          <div class="col-md-9">
            ...
            <span class="form-text">
              ...
              {__("You can change the")} <a target="_blank" href="{$system['system_url']}/comunidade/{$control_panel['url']}/settings/uploads">{__("Uploads Settings")}</a>
            </span>
          </div>
        </div>
          ...
          <tbody>
            {foreach $rows as $row}
              <tr>
                ...
                <td>
                  <a data-toggle="tooltip" data-placement="top" title='{__("Edit")}' href="{$system['system_url']}/comunidade/{$control_panel['url']}/movies/edit_genre/{$row['genre_id']}" class="btn btn-sm btn-icon btn-rounded btn-primary">
                    <i class="fa fa-pencil-alt"></i>
                  </a>
