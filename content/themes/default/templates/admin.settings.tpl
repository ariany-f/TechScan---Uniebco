          ...
          <div class="card-body">
            ...
            <div class="form-group form-row">
              ...
              <div class="col-md-9">
                ...
                <div class="form-text">
                  {__("You can add, edit or delete currencies from")} <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/currencies">{__("Currencies")}</a>
                </div>
              </div>
            </div>
            ...
            <div class="form-table-row">
              ...
              <div>
                ...
                <div class="form-text d-none d-sm-block">
                  ...
                  {__("Make sure you have configured")} <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/gifts">{__("Gifts")}</a>
                </div>
              </div>
              <div class="text-right">
        ...
        <div class="form-table-row">
          ...
          <div>
            ...
            <div class="form-text d-none d-sm-block">
              ...
              {__("Make sure you have configured")} <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/colored_posts">{__("Colored Posts")}</a>
            </div>
          </div>
          <div class="text-right">
            ...
            <div class="form-group form-row">
              ...
              <div class="col-md-9">
                ...
                <span class="form-text">
                  ...
                  {__("Make sure you have configured")} <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/pro">{__("Pro System")}</a>
                </span>
              </div>
            </div>
            ...
            <div class="form-group form-row">
              ...
              <div class="col-md-9">
                ...
                <span class="form-text">
                  ...
                  {__("Make sure you have configured")} <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/settings/sms">{__("SMS Settings")}</a>
                </span>
              </div>
            </div>
          ...
          <div class="card-body">
            ...
            <div class="form-table-row">
              ...
              <div>
                ...
                <div class="form-text d-none d-sm-block">
                  {__("Turn the noty notifications On and Off")} (<a target="_blank" href="{$system['system_url']}/comunidade/content/themes/{$system['theme']}/images/screenshots/noty_notification.png">{__("preview")}</a>)
                </div>
              </div>
              <div class="text-right">
        ...
        <form class="js_ajax-forms" data-url="admin/settings.php?edit=payments">
          <div class="card-body">
            ...
            <div>
              <div class="form-table-row">
                <div class="avatar">
                  <img width="40px" height="40px" src="{$system['system_url']}/comunidade/content/themes/{$system['theme']}/images/cashfree.png">
                </div>
                <div>
