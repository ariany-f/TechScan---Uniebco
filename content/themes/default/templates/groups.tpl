      ...
      <div class="content-tabs rounded-sm shadow-sm clearfix">
        <ul>
          <li {if $view == ""}class="active" {/if}>
            <a href="{$system['system_url']}/comunidade/groups">{__("Discover")}</a>
          </li>
          {if $user->_logged_in}
            <li {if $view == "joined"}class="active" {/if}>
              <a href="{$system['system_url']}/comunidade/groups/joined">{__("Joined Groups")}</a>
            </li>
            <li {if $view == "manage"}class="active" {/if}>
              <a href="{$system['system_url']}/comunidade/groups/manage">{__("My Groups")}</a>
            </li>
          {/if}
        </ul>
