  ...
  <div class="card-header with-icon">
    {if $sub_view == ""}
      <div class="float-right">
        <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/themes/add" class="btn btn-sm btn-primary">
          <i class="fa fa-plus mr5"></i>{__("Add New Theme")}
        </a>
      </div>
    {elseif $sub_view == "add" || $sub_view == "edit"}
      <div class="float-right">
        <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/themes" class="btn btn-sm btn-light">
          ...
          <tbody>
            {foreach $rows as $row}
              <tr>
                <td>{$row['theme_id']}</td>
                <td>
                  <img width="210" src="{$system['system_url']}/comunidade/content/themes/{$row['name']}/thumbnail.png">
                </td>
                <td>{$row['name']}</td>
                <td>
                  {if $row['default']}
                ...
                <td>
                  <a data-toggle="tooltip" data-placement="top" title='{__("Edit")}' href="{$system['system_url']}/comunidade/{$control_panel['url']}/themes/edit/{$row['theme_id']}" class="btn btn-sm btn-icon btn-rounded btn-primary">
