  ...
  <div class="card-header with-icon">
    {if $sub_view == ""}
      <div class="float-right">
        <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/blacklist/add" class="btn btn-sm btn-primary">
          <i class="fa fa-plus mr5"></i>{__("Add New")}
        </a>
      </div>
    {elseif $sub_view == "add"}
      <div class="float-right">
        <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/blacklist" class="btn btn-sm btn-light">
