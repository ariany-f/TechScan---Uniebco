  ...
  <div class="card-header with-icon">
    {if $sub_view == "packages"}
      <div class="float-right">
        <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/pro/add" class="btn btn-sm btn-primary">
          <i class="fa fa-plus mr5"></i>{__("Add New Package")}
        </a>
      </div>
    {elseif $sub_view == "add" || $sub_view == "edit"}
      <div class="float-right">
        <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/pro/packages" class="btn btn-sm btn-light">
        ...
        <div class="form-table-row">
          ...
          <div>
            ...
            <div class="form-text d-none d-sm-block">
              ...
              {__("Make sure you have configured")} <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/settings/payments">{__("Payments Settings")}</a>
            </div>
          </div>
        ...
        <div class="form-table-row">
          ...
          <div>
            ...
            <div class="form-text d-none d-sm-block">
              ...
              {__("Make sure you have enabled")} <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/wallet">{__("Wallet System")}</a>
            </div>
          </div>
          <div class="text-right">
          ...
          <tbody>
            {foreach $rows as $row}
              <tr>
                ...
                <td>
                  <a target="_blank" href="{$system['system_url']}/comunidade/{$control_panel['url']}/pro/edit/{$row['package_id']}">
                ...
                <td>
                  <a data-toggle="tooltip" data-placement="top" title='{__("Edit")}' href="{$system['system_url']}/comunidade/{$control_panel['url']}/pro/edit/{$row['package_id']}" class="btn btn-sm btn-icon btn-rounded btn-primary">
