  ...
  <div class="user-popover-content">
    <div class="user-card">
      ...
      <div class="user-card-info">
        <a class="name" href="{$system['system_url']}/comunidade/{$profile['user_name']}">
        ...
        {/if}
        <div class="info">
          <a href="{$system['system_url']}/comunidade/{$profile['user_name']}/followers">{$profile['followers_count']} {__("followers")}</a>
        </div>
      </div>
    </div>
    ...
    <div class="popover-footer">
      ...
      {else}
        <!-- edit -->
        <a href="{$system['system_url']}/comunidade/settings/profile" class="btn btn-sm btn-light">
...
{else}
  ...
  <div class="user-popover-content">
    <div class="user-card">
      ...
      <div class="user-card-info">
        <a class="name" href="{$system['system_url']}/comunidade/pages/{$profile['page_name']}">{$profile['page_title']}</a>
