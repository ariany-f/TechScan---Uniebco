<div class="card">
  <div class="card-header with-icon">
    {if $sub_view == "banned"}
      <div class="float-right">
        <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/blacklist" class="btn btn-sm btn-danger">
          <i class="fa fa-minus-circle"></i><span class="ml5 d-none d-lg-inline-block">{__("Manage Banned IPs")}</span>
        </a>
      </div>
    {elseif $sub_view == "find"}
      <div class="float-right">
        <a href="{$system['system_url']}/comunidade/{$control_panel['url']}/users" class="btn btn-sm btn-light">
    ...
    {elseif $sub_view == "edit"}
      <div class="float-right">
        ...
        <a target="_blank" href="{$system['system_url']}/comunidade/{$data['user_name']}" class="btn btn-sm btn-info">
  ...
  {if $sub_view == "" || $sub_view == "admins" || $sub_view == "moderators" || $sub_view == "online" || $sub_view == "banned" || $sub_view == "find"}
    ...
    <div class="card-body">
      ...
      <!-- search form -->
      <div class="mb20">
        <form class="form-inline" action="{$system['system_url']}/comunidade/{$control_panel['url']}/users/find" method="get">
        ...
        <table class="table table-striped table-bordered table-hover">
          ...
          <tbody>
            {if $rows}
              {foreach $rows as $row}
                <tr>
                  <td><a href="{$system['system_url']}/comunidade/{$row['user_name']}" target="_blank">{$row['user_id']}</a></td>
                  <td>
                  ...
                  <td>
                    <a href="{$system['system_url']}/comunidade/{$row['user_name']}" target="_blank">
                      {$row['user_name']}
                    </a>
                  </td>
                  ...
                  <td>
                    <a data-toggle="tooltip" data-placement="top" title='{__("Edit")}' href="{$system['system_url']}/comunidade/{$control_panel['url']}/users/edit/{$row['user_id']}" class="btn btn-sm btn-icon btn-rounded btn-primary">
        ...
        <div class="tab-pane active" id="account">
          <form class="js_ajax-forms" data-url="admin/users.php?id={$data['user_id']}&do=edit_account">
              ...
              <div class="col-md-9">
                ...
                <span class="form-text">
                  {if !$system['activation_enabled']}
                    {__("Account activation disabled from your system")} <a target="_blank" href="{$system['system_url']}/comunidade/{$control_panel['url']}/settings/registration">{{__("Registration Settings")}}</a>
                  {else}
            ...
            <div class="card-footer-fake text-right">
              ...
              <button type="button" class="btn btn-danger js_admin-deleter" data-handle="user" data-id="{$data['user_id']}" data-redirect="{$system['system_url']}/comunidade/{$control_panel['url']}/users">
