      ...
      <div class="card">
        <div class="card-header with-icon bg-transparent">
          <div class="float-right">
            <a class="js_chat-new" href="{$system['system_url']}/comunidade/messages/new">
        ...
        {else}
          <div class="card card-messages" style="padding-top: 60px;">
            <div class="card-body text-center text-muted" style="min-height: 510px;">
              ...
              <a class="mt20 btn btn-sm rounded-pill btn-primary js_chat-new" href="{$system['system_url']}/comunidade/messages/new">
