    ...
    <div class="card-body">
      ...
      <div class="form-table-row">
        ...
        <div>
          ...
          <div class="form-text d-none d-sm-block">
            {__("Use the default")} (<a target="_blank" href="{$system['system_url']}/comunidade/content/themes/{$system['theme']}/images/favicon.png">{__("preview")}</a>) ({__("Disable it to use your custom uploaded image")})
          </div>
        </div>
        <div class="text-right">
      ...
      <div class="form-table-row">
        ...
        <div>
          ...
          <div class="form-text d-none d-sm-block">
            {__("Use the default")} (<a target="_blank" href="{$system['system_url']}/comunidade/content/themes/{$system['theme']}/images/og-image.jpg">{__("preview")}</a>) ({__("Disable it to use your custom uploaded image")})
          </div>
        </div>
        <div class="text-right">
